...
- **plan_pack_assignments.py** (23 connections) — `tools/content_factory/plan_pack_assignments.py`
- **PackAssignmentError** (20 connections) — `tools/content_factory/plan_pack_assignments.py`
- **validate_plan()** (18 connections) — `tools/content_factory/plan_pack_assignments.py`
- **Path** (11 connections)
- **_load_metadata()** (9 connections) — `tools/content_factory/plan_pack_assignments.py`
- **_read_json()** (9 connections) — `tools/content_factory/plan_pack_assignments.py`
...
- [apply_review.py](apply_review.py.md) (4 shared connections)
...
- `tools/content_factory/plan_pack_assignments.py`
