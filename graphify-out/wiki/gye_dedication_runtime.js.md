...
- **gye_dedication_runtime.js** (40 connections) — `functions/gye/gye_dedication_runtime.js`
...
- **isActiveState()** (3 connections) — `functions/gye/gye_dedication_runtime.js`
- **joinedAtParts()** (3 connections) — `functions/gye/gye_dedication_runtime.js`
- **legacyReceiptEntry()** (3 connections) — `functions/gye/gye_dedication_runtime.js`
- **mutationData()** (3 connections) — `functions/gye/gye_dedication_runtime.js`
- *... and 15 more nodes in this community*

## Relationships

- [gye_dedication_runtime.test.js](gye_dedication_runtime.test.js.md) (5 shared connections)
