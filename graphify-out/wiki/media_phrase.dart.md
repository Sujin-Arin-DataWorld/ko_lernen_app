...
- **contextEn** (1 connections) — `lib/models/media_phrase.dart`
- **courseUnitId** (1 connections) — `lib/models/media_phrase.dart`
- **english** (1 connections) — `lib/models/media_phrase.dart`
- **fromJson** (1 connections) — `lib/models/media_phrase.dart`
- **german** (1 connections) — `lib/models/media_phrase.dart`
- **grammarIds** (1 connections) — `lib/models/media_phrase.dart`
