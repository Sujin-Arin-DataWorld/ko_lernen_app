...
- **_correctIndex** (1 connections) — `lib/screens/quest_engines/luecken_quest.dart`
- **createState** (1 connections) — `lib/screens/quest_engines/luecken_quest.dart`
- **data** (1 connections) — `lib/screens/quest_engines/luecken_quest.dart`
- **isLast** (1 connections) — `lib/screens/quest_engines/luecken_quest.dart`
- **_lastWrong** (1 connections) — `lib/screens/quest_engines/luecken_quest.dart`
- **onContinue** (1 connections) — `lib/screens/quest_engines/luecken_quest.dart`
- **_options** (1 connections) — `lib/screens/quest_engines/luecken_quest.dart`
- **_report** (1 connections) — `lib/screens/quest_engines/luecken_quest.dart`
- **_reported** (1 connections) — `lib/screens/quest_engines/luecken_quest.dart`
- **_resolved** (1 connections) — `lib/screens/quest_engines/luecken_quest.dart`
