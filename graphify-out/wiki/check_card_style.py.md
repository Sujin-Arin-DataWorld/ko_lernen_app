...
- **_hue_window_fraction()** (3 connections) — `tool/check_card_style.py`
- **load_baseline()** (3 connections) — `tool/check_card_style.py`
- **top8_quant_coverage()** (3 connections) — `tool/check_card_style.py`
