...
- **account-deletion-page.test.js** (7 connections) — `docs/account-deletion-page.test.js`
- **account-deletion-page.js** (5 connections) — `docs/account-deletion-page.js`
- **consumeDeletionProof()** (4 connections) — `docs/account-deletion-page.js`
...
- `docs/account-deletion-page.test.js`
