...
- **.test_generation_override_is_preserved_and_unknown_id_is_rejected()** (1 connections) — `tool/test_build_scene_art_manifest.py`
- **.test_generation_rows_begin_truthfully_not_generated()** (1 connections) — `tool/test_build_scene_art_manifest.py`
- **.test_ids_paths_and_priority_order_are_unique_and_canonical()** (1 connections) — `tool/test_build_scene_art_manifest.py`
- **.test_old_profile_result_is_preserved_but_automatically_invalidated()** (1 connections) — `tool/test_build_scene_art_manifest.py`
- **.test_record_result_measures_png_and_keeps_visual_review_pending()** (1 connections) — `tool/test_build_scene_art_manifest.py`
...
- `tool/test_build_scene_art_manifest.py`
