...
- **_project_path()** (9 connections) — `tool/audit_scene_assets.py`
- **._codes()** (9 connections) — `tool/test_audit_scene_assets.py`
- **_dedupe_issues()** (7 connections) — `tool/audit_scene_assets.py`
- **inspect_png()** (7 connections) — `tool/audit_scene_assets.py`
- **_issue()** (7 connections) — `tool/audit_scene_assets.py`
- **.test_duplicate_dedicated_content_sets_duplicate_of()** (7 connections) — `tool/test_audit_scene_assets.py`
- **.test_duplicate_scenario_id_is_strict()** (7 connections) — `tool/test_audit_scene_assets.py`
- **.test_orphan_filename_is_reported_as_orphan_and_mismatch()** (7 connections) — `tool/test_audit_scene_assets.py`
...
- `tool/audit_scene_assets.py`
- `tool/test_audit_scene_assets.py`
