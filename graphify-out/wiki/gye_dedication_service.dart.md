...
- **callableName** (1 connections) — `lib/services/gye_dedication_service.dart`
- **category** (1 connections) — `lib/services/gye_dedication_service.dart`
- **decorationSlug** (1 connections) — `lib/services/gye_dedication_service.dart`
- **expectedRevision** (1 connections) — `lib/services/gye_dedication_service.dart`
- **_firebaseCallableInvokerForRegion** (1 connections) — `lib/services/gye_dedication_service.dart`
- **_firebaseFailure** (1 connections) — `lib/services/gye_dedication_service.dart`
- **fromCurrent** (1 connections) — `lib/services/gye_dedication_service.dart`
- **_functionRegion** (1 connections) — `lib/services/gye_dedication_service.dart`
- **_gateway** (1 connections) — `lib/services/gye_dedication_service.dart`
