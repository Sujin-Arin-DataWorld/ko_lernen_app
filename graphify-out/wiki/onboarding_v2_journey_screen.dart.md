...
- **onboarding_v2_journey_screen.dart** (72 connections) — `lib/screens/onboarding_v2/onboarding_v2_journey_screen.dart`
...
- **_busy** (1 connections) — `lib/screens/onboarding_v2/onboarding_v2_journey_screen.dart`
- **_commitAndOpenGate** (1 connections) — `lib/screens/onboarding_v2/onboarding_v2_journey_screen.dart`
- **_commitMinimalFromCompanion** (1 connections) — `lib/screens/onboarding_v2/onboarding_v2_journey_screen.dart`
- **_companionForId** (1 connections) — `lib/screens/onboarding_v2/onboarding_v2_journey_screen.dart`
- **_companionId** (1 connections) — `lib/screens/onboarding_v2/onboarding_v2_journey_screen.dart`
- **_coordinator** (1 connections) — `lib/screens/onboarding_v2/onboarding_v2_journey_screen.dart`
- **createState** (1 connections) — `lib/screens/onboarding_v2/onboarding_v2_journey_screen.dart`
- **dispose** (1 connections) — `lib/screens/onboarding_v2/onboarding_v2_journey_screen.dart`
- **firstRunCoordinator** (1 connections) — `lib/screens/onboarding_v2/onboarding_v2_journey_screen.dart`
- **initialResolution** (1 connections) — `lib/screens/onboarding_v2/onboarding_v2_journey_screen.dart`
