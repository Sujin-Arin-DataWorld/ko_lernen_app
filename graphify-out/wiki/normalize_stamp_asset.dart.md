...
- **centerX** (1 connections) — `tool/normalize_stamp_asset.dart`
- **centerY** (1 connections) — `tool/normalize_stamp_asset.dart`
- **cropped** (1 connections) — `tool/normalize_stamp_asset.dart`
- **cropX** (1 connections) — `tool/normalize_stamp_asset.dart`
- **cropY** (1 connections) — `tool/normalize_stamp_asset.dart`
- **_enforceCircleAndRing** (1 connections) — `tool/normalize_stamp_asset.dart`
