...
- **Fixed generation prompt ({SUBJECT}-only swap)** (5 connections) — `docs/LISTENING_CARD_RECIPE.md`
- **72-card taxonomy (6 levels x 12 cells)** (3 connections) — `docs/LISTENING_CARD_ART_SPEC.md`
