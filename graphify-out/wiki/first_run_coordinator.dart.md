...
- **canRecordOnboardingStarted** (1 connections) — `lib/features/onboarding_v2/first_run_coordinator.dart`
- **commit** (1 connections) — `lib/features/onboarding_v2/first_run_coordinator.dart`
- **commitFromCompanionMinimal** (1 connections) — `lib/features/onboarding_v2/first_run_coordinator.dart`
- **_commitGateway** (1 connections) — `lib/features/onboarding_v2/first_run_coordinator.dart`
- **companion** (1 connections) — `lib/features/onboarding_v2/first_run_coordinator.dart`
- **completeStoryPage** (1 connections) — `lib/features/onboarding_v2/first_run_coordinator.dart`
- **consentAccepted** (1 connections) — `lib/features/onboarding_v2/first_run_coordinator.dart`
- **consumeGate** (1 connections) — `lib/features/onboarding_v2/first_run_coordinator.dart`
...
- [onboarding_journey_state.dart](onboarding_journey_state.dart.md) (3 shared connections)
