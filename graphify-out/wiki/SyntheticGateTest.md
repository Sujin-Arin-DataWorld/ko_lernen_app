...
- **SyntheticGateTest** (11 connections) — `tool/test_check_decoration_cutouts.py`
- **.write()** (10 connections) — `tool/test_check_decoration_cutouts.py`
- **cutout()** (8 connections) — `tool/test_check_decoration_cutouts.py`
- **test_check_decoration_cutouts.py** (5 connections) — `tool/test_check_decoration_cutouts.py`
- **.test_palette_with_transparency_passes()** (4 connections) — `tool/test_check_decoration_cutouts.py`
- **.test_bright_saturated_flood_fails()** (3 connections) — `tool/test_check_decoration_cutouts.py`
- **.test_clean_cutout_passes()** (3 connections) — `tool/test_check_decoration_cutouts.py`
...
- `tool/test_check_decoration_cutouts.py`
