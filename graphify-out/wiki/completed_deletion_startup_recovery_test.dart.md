...
- **SecureFeedbackOutboxStore** (2 connections) — `lib/services/content_feedback_outbox.dart`
- **package:ko_lernen_app/data/beta_mission_catalog.dart** (2 connections)
- **_Store** (2 connections) — `test/content_feedback_lifecycle_resume_test.dart`
- **MemoryFeedbackOutboxStore** (2 connections) — `test/content_feedback_outbox_test.dart`
- **_DeletionFeedbackOutboxStore** (2 connections) — `test/services/auth_service_test.dart`
- **_Store** (2 connections) — `test/services/completed_deletion_startup_recovery_test.dart`
- **_Store** (2 connections) — `test/services/content_feedback_lifecycle_test.dart`
- **_MemoryStore** (2 connections) — `test/services/content_feedback_service_test.dart`
- **clear** (1 connections) — `test/content_feedback_lifecycle_resume_test.dart`
- **_concurrentCalls** (1 connections) — `test/content_feedback_lifecycle_resume_test.dart`
- *... and 51 more nodes in this community*

## Relationships

- [content_feedback_outbox_test.dart](content_feedback_outbox_test.dart.md) (10 shared connections)
- [content_feedback_lifecycle_test.dart](content_feedback_lifecycle_test.dart.md) (9 shared connections)
- [milestone_feedback_widget_test.dart](milestone_feedback_widget_test.dart.md) (9 shared connections)
