...
- **productive_assessment_service.dart** (5 connections)
- **hanok_state_service.dart** (3 connections)
- **CanDoSegment** (3 connections) — `lib/models/can_do_segment.dart`
...
- **stateService** (1 connections) — `lib/services/hanok_cutover_service.dart`
- **best** (1 connections) — `lib/services/hanok_experience_projector.dart`
- **_bestSatisfyingProgress** (1 connections) — `lib/services/hanok_experience_projector.dart`
