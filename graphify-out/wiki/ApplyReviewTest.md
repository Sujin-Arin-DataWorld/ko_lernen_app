...
- **ApplyReviewTest** (21 connections) — `tools/content_factory/test_apply_review.py`
- **_vocab_csv()** (11 connections) — `tools/content_factory/test_apply_review.py`
...
- **.test_complete_new_vocab_pack_preview_needs_no_metadata_and_writes_nothing()** (4 connections) — `tools/content_factory/test_apply_review.py`
- **.test_malformed_new_vocab_pack_is_rejected_in_preview_and_apply_without_writing()** (4 connections) — `tools/content_factory/test_apply_review.py`
- **.test_duplicate_draft_ids_are_rejected_before_any_write()** (3 connections) — `tools/content_factory/test_apply_review.py`
- **.test_partial_new_vocab_pack_is_rejected_in_preview_and_apply_without_writing()** (3 connections) — `tools/content_factory/test_apply_review.py`
- **.test_validator_failure_restores_target_and_manifest()** (3 connections) — `tools/content_factory/test_apply_review.py`
...
- `tools/content_factory/test_apply_review.py`
