...
- **deletion_adapters.test.js** (20 connections) — `functions/gye/deletion_adapters.test.js`
- **FakeFirestore** (12 connections) — `functions/gye/deletion_adapters.test.js`
- **clone()** (9 connections) — `functions/gye/deletion_adapters.test.js`
- **createHarness()** (6 connections) — `functions/gye/deletion_adapters.test.js`
- **FakeDocumentSnapshot** (3 connections) — `functions/gye/deletion_adapters.test.js`
- **.seed()** (3 connections) — `functions/gye/deletion_adapters.test.js`
- **.workDocuments()** (3 connections) — `functions/gye/deletion_adapters.test.js`
- **directChildDocumentIdsIncludingMissing()** (2 connections) — `functions/gye/deletion_adapters.test.js`
- **.constructor()** (2 connections) — `functions/gye/deletion_adapters.test.js`
- **.data()** (2 connections) — `functions/gye/deletion_adapters.test.js`
- **.collection()** (2 connections) — `functions/gye/deletion_adapters.test.js`
- **.nodeDocuments()** (2 connections) — `functions/gye/deletion_adapters.test.js`
...
- **.batch()** (1 connections) — `functions/gye/deletion_adapters.test.js`
