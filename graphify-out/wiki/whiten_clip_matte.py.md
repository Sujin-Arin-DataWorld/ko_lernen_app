...
- **whiten_clip_matte.py** (17 connections) — `tool/whiten_clip_matte.py`
...
- **무손실 복사 + BT.709/tv 태그. 픽셀은 한 비트도 안 바뀐다.** (1 connections) — `tool/whiten_clip_matte.py`
- **원본을 읽어 처리본을 **스테이징 디렉터리에** 쓴다. 제자리 덮어쓰기는 하지 않는다. 2026-08-25 에 검증이 클립 1개·프레임…** (1 connections) — `tool/whiten_clip_matte.py`
