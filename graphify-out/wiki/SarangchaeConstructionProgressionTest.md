...
- **.test_stage_8_adds_floor_and_numaru_before_walls()** (4 connections) — `tool/test_sarangchae_construction_progression.py`
- **ndarray** (3 connections)
- **Path** (2 connections)
- **.test_registered_building_stages_share_canvas_center_and_ground()** (1 connections) — `tool/test_sarangchae_construction_progression.py`
- **.test_stage_10_work_props_remain_a_separate_overlay()** (1 connections) — `tool/test_sarangchae_construction_progression.py`
- **.test_stage_12_base_is_exact_v3_master_bytes()** (1 connections) — `tool/test_sarangchae_construction_progression.py`
...
- `tool/test_sarangchae_construction_progression.py`
