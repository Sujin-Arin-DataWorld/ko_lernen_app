...
- **_blockedResult** (1 connections) — `lib/services/book_analysis_service.dart`
- **BookAnalysisCredentials** (1 connections) — `lib/services/book_analysis_service.dart`
- **BookAnalysisCredentialsProvider** (1 connections) — `lib/services/book_analysis_service.dart`
- **BookAnalysisService** (1 connections) — `lib/services/book_analysis_service.dart`
- **firebaseCredentials** (1 connections) — `lib/services/book_analysis_service.dart`
- **_grammarPatternsCache** (1 connections) — `lib/services/book_analysis_service.dart`
- **idToken** (1 connections) — `lib/services/book_analysis_service.dart`
- **_loadGrammarPatterns** (1 connections) — `lib/services/book_analysis_service.dart`
- **_localStub** (1 connections) — `lib/services/book_analysis_service.dart`
- **normalizeTargetLanguage** (1 connections) — `lib/services/book_analysis_service.dart`
- **_parseCloudResponse** (1 connections) — `lib/services/book_analysis_service.dart`
