...
- **assess** (1 connections) — `lib/services/pronunciation_assessment_client.dart`
- **assessmentId** (1 connections) — `lib/services/pronunciation_assessment_client.dart`
- **_assessmentIdPattern** (1 connections) — `lib/services/pronunciation_assessment_client.dart`
- **callableName** (1 connections) — `lib/services/pronunciation_assessment_client.dart`
- **category** (1 connections) — `lib/services/pronunciation_assessment_client.dart`
- **completeness** (1 connections) — `lib/services/pronunciation_assessment_client.dart`
- **completenessScore** (1 connections) — `lib/services/pronunciation_assessment_client.dart`
- **_firebaseFailure** (1 connections) — `lib/services/pronunciation_assessment_client.dart`
- **_firebaseInvokerForRegion** (1 connections) — `lib/services/pronunciation_assessment_client.dart`
- **fluency** (1 connections) — `lib/services/pronunciation_assessment_client.dart`
- **fluencyScore** (1 connections) — `lib/services/pronunciation_assessment_client.dart`
- **_functionRegion** (1 connections) — `lib/services/pronunciation_assessment_client.dart`
- **id** (1 connections) — `lib/services/pronunciation_assessment_client.dart`
