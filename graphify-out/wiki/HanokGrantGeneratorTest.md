...
- **.test_draft_is_not_a_runtime_asset_and_inputs_are_explicit()** (1 connections) — `tools/content_factory/test_build_hanok_grants.py`
- **.test_generated_file_is_byte_exact_and_check_mode_passes()** (1 connections) — `tools/content_factory/test_build_hanok_grants.py`
- **.test_new_additive_slot_requires_and_accepts_an_authored_grant()** (1 connections) — `tools/content_factory/test_build_hanok_grants.py`
