...
- **analyticsClient** (1 connections) — `lib/services/privacy_consent_service.dart`
- **analyticsEnabled** (1 connections) — `lib/services/privacy_consent_service.dart`
- **applyStored** (1 connections) — `lib/services/privacy_consent_service.dart`
- **_controller** (1 connections) — `lib/services/privacy_consent_service.dart`
- **crashClient** (1 connections) — `lib/services/privacy_consent_service.dart`
- **_deleteCrashReports** (1 connections) — `lib/services/privacy_consent_service.dart`
- **_deleteCrashReportsRequired** (1 connections) — `lib/services/privacy_consent_service.dart`
- **deleteUnsentReports** (1 connections) — `lib/services/privacy_consent_service.dart`
- **_disableCrashCollectionAndDeleteReports** (1 connections) — `lib/services/privacy_consent_service.dart`
- **handleFlutterError** (1 connections) — `lib/services/privacy_consent_service.dart`
- **handlePlatformError** (1 connections) — `lib/services/privacy_consent_service.dart`
