...
- **asset_recipe.py** (18 connections) — `tool/asset_recipe.py`
- **Any** (11 connections)
...
- **_ingest_cutout()** (4 connections) — `tool/asset_recipe.py`
- **load_recipe()** (4 connections) — `tool/asset_recipe.py`
...
- [_minimal_cutout_recipe](_minimal_cutout_recipe.md) (1 shared connections)

## Source Files

- `tool/asset_recipe.py`
