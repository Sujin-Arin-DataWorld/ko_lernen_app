...
- **didUpdateWidget** (1 connections) — `lib/widgets/sori/deck_coach.dart`
- **dispose** (1 connections) — `lib/widgets/sori/deck_coach.dart`
- **_hideTimer** (1 connections) — `lib/widgets/sori/deck_coach.dart`
- **initState** (1 connections) — `lib/widgets/sori/deck_coach.dart`
- **markSoriDeckNudgeShown** (1 connections) — `lib/widgets/sori/deck_coach.dart`
- **maybeShowSoriDeckCoach** (1 connections) — `lib/widgets/sori/deck_coach.dart`
- **_onPulse** (1 connections) — `lib/widgets/sori/deck_coach.dart`
- **revision** (1 connections) — `lib/widgets/sori/deck_coach.dart`
- **_soriDeckCoachFiredThisSession** (1 connections) — `lib/widgets/sori/deck_coach.dart`
- **_soriDeckCoachResetRevision** (1 connections) — `lib/widgets/sori/deck_coach.dart`
