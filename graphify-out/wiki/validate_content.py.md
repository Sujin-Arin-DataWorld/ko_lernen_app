...
- **IntegrateReviewBatchesTest** (10 connections) — `tools/content_factory/test_integrate_review_batches.py`
...
- **._snapshot()** (3 connections) — `tools/content_factory/test_integrate_review_batches.py`
- **.test_apply_promotes_every_row_and_keeps_the_graph_valid()** (3 connections) — `tools/content_factory/test_integrate_review_batches.py`
- **._copy()** (2 connections) — `tools/content_factory/test_integrate_review_batches.py`
...
- [validate_promoted_batch.py](validate_promoted_batch.py.md) (1 shared connections)

## Source Files

- `tools/content_factory/test_integrate_review_batches.py`
