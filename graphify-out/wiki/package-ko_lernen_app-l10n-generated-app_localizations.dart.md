...
- **package:ko_lernen_app/l10n/generated/app_localizations.dart** (212 connections)
- **package:ko_lernen_app/theme.dart** (172 connections)
- **dedicated_feedback_route_test.dart** (54 connections) — `test/dedicated_feedback_route_test.dart`
...
- **vocab_pack_screen_overflow_guard_test.dart** (21 connections) — `test/vocab_pack_screen_overflow_guard_test.dart`
- **vocab_pack_screen_repeat_counter_test.dart** (21 connections) — `test/vocab_pack_screen_repeat_counter_test.dart`
- **FlipCard** (20 connections) — `lib/widgets/flip_card.dart`
- **package:ko_lernen_app/screens/vocab_pack_screen.dart** (20 connections)
- **culture_note_loader_lifecycle_test.dart** (20 connections) — `test/culture_note_loader_lifecycle_test.dart`
...
- [package:flutter_test/flutter_test.dart](package-flutter_test-flutter_test.dart.md) (106 shared connections)
- [package:ko_lernen_app/models/curriculum.dart](package-ko_lernen_app-models-curriculum.dart.md) (59 shared connections)
- [package:flutter/material.dart](package-flutter-material.dart.md) (54 shared connections)
- [vocab_notebook_studio_screen_test.dart](vocab_notebook_studio_screen_test.dart.md) (40 shared connections)
- [hanok_world_screen_test.dart](hanok_world_screen_test.dart.md) (32 shared connections)
- [dart:ui](dart-ui.md) (29 shared connections)
- [standalone_games_uiux_test.dart](standalone_games_uiux_test.dart.md) (26 shared connections)
- [package:ko_lernen_app/models/scenario.dart](package-ko_lernen_app-models-scenario.dart.md) (26 shared connections)
- [test/profile_screen_test.dart](test-profile_screen_test.dart.md) (24 shared connections)
- [game_layout_test.dart](game_layout_test.dart.md) (23 shared connections)
- [bookshelf_custom_pack_uiux_test.dart](bookshelf_custom_pack_uiux_test.dart.md) (21 shared connections)
- [dart:async](dart-async.md) (19 shared connections)
...
- `test/onboarding_preview_screen_test.dart`
- `test/review_deck_order_test.dart`
- `test/review_session_flipgate_test.dart`
- `test/review_session_loading_state_test.dart`
- `test/review_session_screen_speakable_test.dart`
