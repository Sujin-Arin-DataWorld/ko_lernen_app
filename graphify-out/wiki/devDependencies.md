...
- **devDependencies** (16 connections) — `hangul-sori-site-local/package.json`
- **@cloudflare/vite-plugin** (2 connections) — `hangul-sori-site-local/package.json`
- **eslint** (2 connections) — `hangul-sori-site-local/package.json`
- **eslint-config-next** (2 connections) — `hangul-sori-site-local/package.json`
...
- **@vitejs/plugin-rsc** (2 connections) — `hangul-sori-site-local/package.json`
- **wrangler** (2 connections) — `hangul-sori-site-local/package.json`
