...
- **Task 6 Report: Restore, English Book Analysis, and TTS Playback Rate** (9 connections) — `.superpowers/sdd/2026-07-29-release-hardening/task-6-report.md`
...
- **Self-Review** (1 connections) — `.superpowers/sdd/2026-07-29-release-hardening/task-6-report.md`
- **TTS GREEN** (1 connections) — `.superpowers/sdd/2026-07-29-release-hardening/task-6-report.md`
- **TTS RED** (1 connections) — `.superpowers/sdd/2026-07-29-release-hardening/task-6-report.md`
