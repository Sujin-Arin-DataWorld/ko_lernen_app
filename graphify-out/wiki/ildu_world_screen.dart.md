...
- **_EstateMap** (2 connections) — `lib/screens/ildu_world_screen.dart`
- **_GateSheet** (2 connections) — `lib/screens/ildu_world_screen.dart`
- **_LoadFailure** (2 connections) — `lib/screens/ildu_world_screen.dart`
- **_PlaceSheet** (2 connections) — `lib/screens/ildu_world_screen.dart`
- **_ProgressHeader** (2 connections) — `lib/screens/ildu_world_screen.dart`
- **_StateLabel** (2 connections) — `lib/screens/ildu_world_screen.dart`
- **_WorldBody** (2 connections) — `lib/screens/ildu_world_screen.dart`
- **_addDecoration** (1 connections) — `lib/screens/ildu_world_screen.dart`
- **anchor** (1 connections) — `lib/screens/ildu_world_screen.dart`
- **_anchorDirections** (1 connections) — `lib/screens/ildu_world_screen.dart`
- **_anchorGestureActive** (1 connections) — `lib/screens/ildu_world_screen.dart`
- **_anchorGestureMapTransform** (1 connections) — `lib/screens/ildu_world_screen.dart`
- **_AnchorGestureSession** (1 connections) — `lib/screens/ildu_world_screen.dart`
- **anchorId** (1 connections) — `lib/screens/ildu_world_screen.dart`
...
- [hangul_strokes.dart](hangul_strokes.dart.md) (2 shared connections)
