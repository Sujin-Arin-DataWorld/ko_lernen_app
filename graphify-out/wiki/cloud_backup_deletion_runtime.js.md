...
- **cloud_backup_deletion_runtime.js** (29 connections) — `functions/gye/cloud_backup_deletion_runtime.js`
- **createWork()** (6 connections) — `functions/gye/cloud_backup_deletion_runtime.js`
- **assertBackupPath()** (5 connections) — `functions/gye/cloud_backup_deletion_runtime.js`
- **assertRequest()** (5 connections) — `functions/gye/cloud_backup_deletion_runtime.js`
- **deleteCloudBackup()** (5 connections) — `functions/gye/cloud_backup_deletion_runtime.js`
- **validOpaqueSegment()** (5 connections) — `functions/gye/cloud_backup_deletion_runtime.js`
- **validWorkId()** (5 connections) — `functions/gye/cloud_backup_deletion_runtime.js`
- **assertParentChild()** (4 connections) — `functions/gye/cloud_backup_deletion_runtime.js`
...
- [createFirestoreCloudBackupDeletionRepository](createFirestoreCloudBackupDeletionRepository.md) (18 shared connections)
- [cloud_backup_deletion_runtime.test.js](cloud_backup_deletion_runtime.test.js.md) (8 shared connections)
