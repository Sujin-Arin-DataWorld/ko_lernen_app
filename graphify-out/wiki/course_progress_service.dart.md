...
- **canonicalGeneration** (1 connections) — `lib/services/course_progress_service.dart`
- **captureForCloudReconciliation** (1 connections) — `lib/services/course_progress_service.dart`
- **captureForPlacementVerification** (1 connections) — `lib/services/course_progress_service.dart`
- **conceptStates** (1 connections) — `lib/services/course_progress_service.dart`
- **CourseMasteryLocalCapture** (1 connections) — `lib/services/course_progress_service.dart`
- **CoursePlacementVerificationCapture** (1 connections) — `lib/services/course_progress_service.dart`
- **currentCourseUnitId** (1 connections) — `lib/services/course_progress_service.dart`
- **initializeForPlacement** (1 connections) — `lib/services/course_progress_service.dart`
