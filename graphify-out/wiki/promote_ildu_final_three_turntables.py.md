...
- **.review_root()** (2 connections) — `tool/promote_ildu_final_three_turntables.py`
- **.test_all_promoted_frames_are_bounded_transparent_rgba()** (2 connections) — `tool/test_promote_ildu_final_three_turntables.py`
- **.test_originals_are_byte_preserved_and_review_matches_runtime()** (2 connections) — `tool/test_promote_ildu_final_three_turntables.py`
- **.filename()** (1 connections) — `tool/promote_ildu_final_three_turntables.py`
...
- `tool/promote_ildu_final_three_turntables.py`
- `tool/test_promote_ildu_final_three_turntables.py`
