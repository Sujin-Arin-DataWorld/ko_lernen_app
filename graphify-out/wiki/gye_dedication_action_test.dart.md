...
- **package:ko_lernen_app/widgets/sori/gye_dedication_action.dart** (1 connections)
- **_currentExhibit** (1 connections) — `test/gye_dedication_action_test.dart`
- **_host** (1 connections) — `test/gye_dedication_action_test.dart`
- **main** (1 connections) — `test/gye_dedication_action_test.dart`
- **_membershipEpochOne** (1 connections) — `test/gye_dedication_action_test.dart`
- **_membershipEpochTwo** (1 connections) — `test/gye_dedication_action_test.dart`
- **_membershipOne** (1 connections) — `test/gye_dedication_action_test.dart`
- **_membershipTwo** (1 connections) — `test/gye_dedication_action_test.dart`
- **_openAndConfirmFirstCandidate** (1 connections) — `test/gye_dedication_action_test.dart`
- **pump** (1 connections) — `test/gye_dedication_action_test.dart`
- **pumpAndSettle** (1 connections) — `test/gye_dedication_action_test.dart`
- **tap** (1 connections) — `test/gye_dedication_action_test.dart`
- **_withdrawnTombstone** (1 connections) — `test/gye_dedication_action_test.dart`
- **calls** (1 connections) — `test/gye_dedication_service_test.dart`
- **decorationSlug** (1 connections) — `test/gye_dedication_service_test.dart`
- **expectedJoinedAtNanos** (1 connections) — `test/gye_dedication_service_test.dart`
- **expectedJoinedAtSeconds** (1 connections) — `test/gye_dedication_service_test.dart`
- **expectedMembershipId** (1 connections) — `test/gye_dedication_service_test.dart`
- **expectedRevision** (1 connections) — `test/gye_dedication_service_test.dart`
