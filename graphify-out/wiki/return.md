...
- **hangul_composer_test.dart** (7 connections) — `test/hangul_composer_test.dart`
- **buf** (1 connections) — `lib/services/hangul_util.dart`
- **cho** (1 connections) — `lib/services/hangul_util.dart`
- **chosungTable** (1 connections) — `lib/services/hangul_util.dart`
- **composeHangulSyllable** (1 connections) — `lib/services/hangul_util.dart`
- **extractChosung** (1 connections) — `lib/services/hangul_util.dart`
- **fromCharCode** (1 connections) — `lib/services/hangul_util.dart`
- **hangulLength** (1 connections) — `lib/services/hangul_util.dart`
- **hangulSyllableBase** (1 connections) — `lib/services/hangul_util.dart`
- **hangulSyllableLast** (1 connections) — `lib/services/hangul_util.dart`
- **idx** (1 connections) — `lib/services/hangul_util.dart`
- **isHangulSyllable** (1 connections) — `lib/services/hangul_util.dart`
- **isPureHangul** (1 connections) — `lib/services/hangul_util.dart`
- **jong** (1 connections) — `lib/services/hangul_util.dart`
- **jongsungTable** (1 connections) — `lib/services/hangul_util.dart`
- **jung** (1 connections) — `lib/services/hangul_util.dart`
