...
- **build_batch_18_social_language.py** (17 connections) — `tools/content_factory/build_batch_18_social_language.py`
- **build()** (14 connections) — `tools/content_factory/build_batch_18_social_language.py`
- **Batch18BuildTest** (10 connections) — `tools/content_factory/test_build_batch_18_social_language.py`
- **Batch18Error** (9 connections) — `tools/content_factory/build_batch_18_social_language.py`
- **Any** (8 connections)
...
- **_tuple_localized()** (3 connections) — `tools/content_factory/build_batch_18_social_language.py`
- **_vocab_rows()** (3 connections) — `tools/content_factory/build_batch_18_social_language.py`
- **.setUpClass()** (3 connections) — `tools/content_factory/test_build_batch_18_social_language.py`
- **.test_ids_and_review_ledgers_match_promotion_state()** (3 connections) — `tools/content_factory/test_build_batch_18_social_language.py`
- **main()** (2 connections) — `tools/content_factory/build_batch_18_social_language.py`
...
- `tools/content_factory/build_batch_18_social_language.py`
- `tools/content_factory/data/batch_18_social_language.py`
- `tools/content_factory/test_build_batch_18_social_language.py`
