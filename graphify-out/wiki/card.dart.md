...
- **accent** (1 connections) — `lib/widgets/sori/card.dart`
- **_borderRadius** (1 connections) — `lib/widgets/sori/card.dart`
- **build** (1 connections) — `lib/widgets/sori/card.dart`
- **child** (1 connections) — `lib/widgets/sori/card.dart`
- **createState** (1 connections) — `lib/widgets/sori/card.dart`
- **_defaultPadding** (1 connections) — `lib/widgets/sori/card.dart`
- **eaves** (1 connections) — `lib/widgets/sori/card.dart`
- **height** (1 connections) — `lib/widgets/sori/card.dart`
- **_interactive** (1 connections) — `lib/widgets/sori/card.dart`
- **onLongPress** (1 connections) — `lib/widgets/sori/card.dart`
- **onTap** (1 connections) — `lib/widgets/sori/card.dart`
- **padding** (1 connections) — `lib/widgets/sori/card.dart`
- **_pressed** (1 connections) — `lib/widgets/sori/card.dart`
- **_radius** (1 connections) — `lib/widgets/sori/card.dart`
