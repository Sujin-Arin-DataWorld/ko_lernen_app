...
- **pronunciation/index.js** (25 connections) — `functions/pronunciation/index.js`
- **pronunciation_request_guard.js** (21 connections) — `functions/pronunciation/pronunciation_request_guard.js`
- **pronunciation_request_guard.test.js** (18 connections) — `functions/pronunciation/test/pronunciation_request_guard.test.js`
...
- **decodeBase64()** (3 connections) — `functions/pronunciation/pronunciation_request_guard.js`
...
- `functions/pronunciation/index.js`
- `functions/pronunciation/pronunciation_request_guard.js`
- `functions/pronunciation/test/pronunciation_request_guard.test.js`
