...
class AppL10nDe extends AppL10n {
  ...
  @override
  String get onboardingV2Story1CurriculumSourcesAction => 'Quellen ansehen';
  ...
  String onboardingV2Story4CatalogBody(int count) {
    return 'Beispiele aus $count aktuellen Aktivitäten. Ansehen verändert nichts.';
  }
  ...
  String soriStageConfirmedUnits(int built, int total) {
    return '$built / $total Lerneinheiten bestätigt';
  }
  ...
  @override
  String get soriStageHanokNoUnits => 'Noch keine Lerneinheiten verfügbar.';
