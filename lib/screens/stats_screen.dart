      ...
      body: ListView(
        ...
        children: [
          ...
          _StatCard(
            ...
            rows: [
              _MetricRow(label: '✅ Gewusst', value: '${Storage.vokCorrect}'),
              _MetricRow(label: '❌ Nicht gewusst', value: '${Storage.vokWrong}'),
              _MetricRow(label: '⏭ Übersprungen', value: '${Storage.vokSkipped}'),
          ...
          _StatCard(
            ...
            rows: [
              _MetricRow(label: '✅ Richtig', value: '${Storage.chosungCorrect}'),
              _MetricRow(label: '❌ Falsch',  value: '${Storage.chosungWrong}'),
          ...
          _StatCard(
            ...
            rows: [
              ...
              _MetricRow(label: '💔 Verloren', value: '${Storage.wordleLosses}'),
              _MetricRow(label: '🔥 ${t.statsWordleStreak}', value: '${Storage.wordleStreak}'),
              _MetricRow(label: '⭐ Beste',  value: '${Storage.wordleBestStreak}'),
              _MetricRow(label: '🎯 Quote',  value: '$wordleRate %', accent: true),
            ],
          ),
        ],
      ),
