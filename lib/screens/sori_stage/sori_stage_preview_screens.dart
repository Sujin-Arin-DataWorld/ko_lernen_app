      ...
      body: SafeArea(
        child: SoriContentClamp(
          ...
          builder: (context, padding) => ListView(
            ...
            children: [
              _PreviewHeader(
                eyebrow: t.soriStagePreviewCopy('todayEyebrow'),
                title: t.soriStagePreviewCopy('todayTitle'),
              ),
              ...
              const SizedBox(height: Spacing.xl),
              _SectionTitle(t.soriStagePreviewCopy('nearComplete')),
              const SizedBox(height: Spacing.sm),
              _QuestRow(
                label: t.soriStagePreviewCopy('cafeOrder'),
                value: t.soriStagePreviewProgress(4, 5),
                fraction: .8,
              ),
              _QuestRow(
                label: t.soriStagePreviewCopy('strongWords'),
                value: t.soriStagePreviewProgress(18, 25),
                fraction: .72,
              ),
              _QuestRow(
                label: t.soriStagePreviewCopy('sevenDayStreak'),
                value: t.soriStagePreviewProgress(5, 7),
                fraction: .71,
              ),
            ],
          ),
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              _PreviewHeader(
                eyebrow: t.soriStagePreviewCopy('lessonEyebrow'),
                title: t.soriStagePreviewCopy('lessonPhrase'),
                light: true,
              ),
              const SizedBox(height: Spacing.xl),
              Expanded(
                  ...
                  builder: (context, constraints) {
                    ...
                    final stages = [
                      _LessonStage(
                        ...
                        label: t.soriStagePreviewCopy('listen'),
                        detail: t.soriStagePreviewCopy('naturalTempo'),
                        color: SoriActivityColors.listening,
                      ),
                      _LessonStage(
                        icon: Icons.mic_rounded,
                        label: t.soriStagePreviewCopy('speak'),
                        detail: t.soriStagePreviewCopy('rhythmMouth'),
                        color: SoriActivityColors.speaking,
                      ),
                      _LessonStage(
                        icon: Icons.memory_rounded,
                        label: t.soriStagePreviewCopy('remember'),
                        detail: t.soriStagePreviewCopy('withoutHelp'),
              ...
              const SizedBox(height: Spacing.lg),
              SoriButton(
                label: t.soriStagePreviewCopy('beginListening'),
                onTap: () {},
              ),
            ],
          ),
          ...
          builder: (context, padding) => ListView(
            ...
            children: [
              _PreviewHeader(
                eyebrow: AppL10n.of(
                  context,
                ).soriStagePreviewCopy('journeyEyebrow'),
                title: AppL10n.of(context).soriStagePreviewCopy('journeyTitle'),
              ),
              const SizedBox(height: Spacing.xl),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            t.soriStagePreviewCopy('missionEyebrow'),
            style: const TextStyle(
              color: SoriColors.gold,
              fontWeight: FontWeight.w700,
              letterSpacing: 1.1,
          ...
          const SizedBox(height: Spacing.sm),
          Text(
            t.soriStagePreviewCopy('missionTitle'),
            style: const TextStyle(
              color: Colors.white,
              fontSize: 28,
              fontWeight: FontWeight.w700,
          ...
          Row(
            children: [
              ...
              Expanded(
                child: Text(
                  t.soriStagePreviewCopy('missionReward'),
                  style: const TextStyle(
          ...
          const SizedBox(height: Spacing.lg),
          SoriButton(
            label: t.soriStagePreviewCopy('missionStart'),
            onTap: () {},
          ),
        ],
      ),
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  t.soriStagePreviewCopy('bojagiWaiting'),
                  style: const TextStyle(
                    fontSize: 18,
                    fontWeight: FontWeight.w700,
                  ),
                ),
                Text(t.soriStagePreviewCopy('bojagiBody')),
              ],
            ),
          ),
        ],
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  '${AppL10n.of(context).soriStageMinutes(entry.minutes)} · ${entry.reward.items.map((item) => localCopy(context, item.label)).join(' · ')}',
                  maxLines: 2,
                ),
              ],
            ),
