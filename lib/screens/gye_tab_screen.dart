      ...
      builder: (ctx) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(t.gyePrivacyTitle, style: tt.h3),
    ...
    return ListView(
      ...
      children: [
        ...
        ClipRRect(
          ...
          child: AspectRatio(
            aspectRatio: 393 / 220,
            child: const GyeHanok(meta: _previewMeta, showcase: true),
          ),
        ),
        const SizedBox(height: Spacing.xs),
        Text(
          ...
          child: Column(
            children: [
              ...
              _CompactPoint(
                ...
                onInfoTap: () => _showDetailsSheet(context),
              ),
            ],
          ),
        ),
        ...
        SoriCard(
          ...
          child: Row(
            children: [
              ...
              IconButton(
                icon: Icon(Icons.info_outline_rounded, size: 20, color: s.textMuted),
    ...
    return SoriCard(
      ...
      child: Row(
        children: [
          ...
          if (onInfoTap != null)
            IconButton(
              icon: Icon(Icons.info_outline_rounded, size: 18, color: s.textMuted),
              onPressed: onInfoTap,
            ),
        ],
      ),
