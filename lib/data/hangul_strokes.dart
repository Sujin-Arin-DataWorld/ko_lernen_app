...
const Map<String, List<Stroke>> hangulStrokes = {
  // ── Konsonanten ──
  'ㄱ': [LineStroke([Offset(30,55), Offset(172,55), Offset(172,178)])],
  'ㄴ': [LineStroke([Offset(42,28), Offset(42,170), Offset(178,170)])],
  'ㄷ': [
  ...
  'ㅡ': [LineStroke([Offset(22,110), Offset(195,110)])],
  'ㅣ': [LineStroke([Offset(110,22), Offset(110,195)])],
  'ㅐ': [
