...
abstract final class PackArtworkCatalog {
  ...
  static const dedicatedPackIds = <String>{
    ...
    'b2_2026_social_topics_1',
    'b2_abstract_concepts_1',
    'b2_civic_meeting_1',
    'b2_collaborative_feedback_1',
    'b2_communication',
    'b2_customer_escalation_1',
    'b2_decisions_perspectives_1',
    'b2_digital_judgment_1',
    'b2_education',
    'b2_environment_1',
    'b2_events_culture_1',
    'b2_formal_agreement_1',
    'b2_formal_complaint_1',
    'b2_honorifics_1',
    'b2_household_practical_1',
    'b2_housing_dispute_1',
    'b2_housing_migration_2026_1',
    'b2_language_change',
    'b2_language_grammar_1',
    'b2_language_society_1',
    'b2_life_values',
    'b2_literature_emotion',
    'b2_manners_society_1',
    'b2_media_literacy_1',
    'b2_misc',
    'b2_modern_life_1',
    'b2_partner_ancestral_rite_1',
    'b2_partner_boundary_1',
    'b2_partner_family_money_1',
    'b2_partner_holiday_duty_1',
    'b2_partner_honorific_trap_1',
    'b2_partner_inlaws_1',
    'b2_partner_marriage_talk_1',
    'b2_partner_public_intro_1',
    'b2_performance_review_1',
    'b2_personal_boundaries_1',
    'b2_policy_brief_1',
    'b2_reading_response_1',
    'b2_relationships_people_1',
    'b2_research_summary_1',
    'b2_safety_rules_1',
    'b2_shared_space_coordination_1',
    'b2_society_1',
    'b2_society_2',
    'b2_team_negotiation_1',
    'b2_thinking_1',
    'b2_thinking_2',
    'b2_thinking_verbs_1',
    'b2_work',
