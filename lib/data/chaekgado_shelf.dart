...
/// 칸 위에 실제로 찍히는 **짧은** 이름표 (1~2 단어).
///
/// `chaekgadoSlotLabel` 과 동형이지만 ARB 키만 `listeningShelfShort*` 로
/// 갈린다. 긴 이름은 스크린리더(Semantics)·두루마리 헤더용으로 계속 살아
/// 있고, 163dp 칸에 12.5px w700 두 줄로 들어가는 건 이쪽이다.
/// (계획 `cheerful-percolating-shore.md` "ARB — 짧은 칸 이름".)
String chaekgadoSlotShortLabel(AppL10n t, String imageKey) =>
    switch (imageKey) {
      'A1Transit' => t.listeningShelfShortA1Transit,
      'A1Arrival' => t.listeningShelfShortA1Arrival,
      'A1Counter' => t.listeningShelfShortA1Counter,
      'A1Cafe' => t.listeningShelfShortA1Cafe,
      'A1Home' => t.listeningShelfShortA1Home,
      'A1Greeting' => t.listeningShelfShortA1Greeting,
      'A1Repair' => t.listeningShelfShortA1Repair,
      'A1Health' => t.listeningShelfShortA1Health,
      'A1Family' => t.listeningShelfShortA1Family,
      'A1Numbers' => t.listeningShelfShortA1Numbers,
      'A1Phone' => t.listeningShelfShortA1Phone,
      'A1Wayfinding' => t.listeningShelfShortA1Wayfinding,
      'A2Travel' => t.listeningShelfShortA2Travel,
      'A2Bank' => t.listeningShelfShortA2Bank,
      'A2Shopping' => t.listeningShelfShortA2Shopping,
      'A2Cafe' => t.listeningShelfShortA2Cafe,
      'A2Body' => t.listeningShelfShortA2Body,
      'A2Neighbourhood' => t.listeningShelfShortA2Neighbourhood,
      'A2Work' => t.listeningShelfShortA2Work,
      'A2Plans' => t.listeningShelfShortA2Plans,
      'A2Family' => t.listeningShelfShortA2Family,
      'A2Delivery' => t.listeningShelfShortA2Delivery,
      'A2Enrolment' => t.listeningShelfShortA2Enrolment,
      'A2Booking' => t.listeningShelfShortA2Booking,
      'B1Repairs' => t.listeningShelfShortB1Repairs,
      'B1Refund' => t.listeningShelfShortB1Refund,
      'B1Receipts' => t.listeningShelfShortB1Receipts,
      'B1Delay' => t.listeningShelfShortB1Delay,
      'B1Paperwork' => t.listeningShelfShortB1Paperwork,
      'B1Team' => t.listeningShelfShortB1Team,
      'B1Neighbours' => t.listeningShelfShortB1Neighbours,
      'B1Feelings' => t.listeningShelfShortB1Feelings,
      'B1Family' => t.listeningShelfShortB1Family,
      'B1Insurance' => t.listeningShelfShortB1Insurance,
      'B1Incident' => t.listeningShelfShortB1Incident,
      'B1Cancellation' => t.listeningShelfShortB1Cancellation,
      'B2Meetings' => t.listeningShelfShortB2Meetings,
      'B2Evidence' => t.listeningShelfShortB2Evidence,
      'B2Negotiation' => t.listeningShelfShortB2Negotiation,
      'B2Contracts' => t.listeningShelfShortB2Contracts,
      'B2Notices' => t.listeningShelfShortB2Notices,
      'B2Escalation' => t.listeningShelfShortB2Escalation,
      'B2Medical' => t.listeningShelfShortB2Medical,
      'B2Public' => t.listeningShelfShortB2Public,
      'B2Family' => t.listeningShelfShortB2Family,
      'B2Hiring' => t.listeningShelfShortB2Hiring,
      'B2Authorities' => t.listeningShelfShortB2Authorities,
      'B2Privacy' => t.listeningShelfShortB2Privacy,
      'C1Briefing' => t.listeningShelfShortC1Briefing,
      'C1Uncertainty' => t.listeningShelfShortC1Uncertainty,
      'C1Access' => t.listeningShelfShortC1Access,
      'C1InvisibleLabor' => t.listeningShelfShortC1InvisibleLabor,
      'C1Conflict' => t.listeningShelfShortC1Conflict,
      'C1Policy' => t.listeningShelfShortC1Policy,
      'C1Consent' => t.listeningShelfShortC1Consent,
      'C1Critique' => t.listeningShelfShortC1Critique,
      'C1Mediation' => t.listeningShelfShortC1Mediation,
      'C1Methodology' => t.listeningShelfShortC1Methodology,
      'C1Facework' => t.listeningShelfShortC1Facework,
      'C1Attribution' => t.listeningShelfShortC1Attribution,
      'C2Automation' => t.listeningShelfShortC2Automation,
      'C2Records' => t.listeningShelfShortC2Records,
      'C2Discourse' => t.listeningShelfShortC2Discourse,
      'C2Authority' => t.listeningShelfShortC2Authority,
      'C2Impact' => t.listeningShelfShortC2Impact,
      'C2Memory' => t.listeningShelfShortC2Memory,
      'C2Ethics' => t.listeningShelfShortC2Ethics,
      'C2History' => t.listeningShelfShortC2History,
      'C2Translation' => t.listeningShelfShortC2Translation,
      'C2Limitation' => t.listeningShelfShortC2Limitation,
      'C2Jurisdiction' => t.listeningShelfShortC2Jurisdiction,
      'C2Representation' => t.listeningShelfShortC2Representation,
      'SocialFriends' => t.listeningShelfShortSocialFriends,
      'SocialDating' => t.listeningShelfShortSocialDating,
      'SocialFandom' => t.listeningShelfShortSocialFandom,
      _ => imageKey,
    };
