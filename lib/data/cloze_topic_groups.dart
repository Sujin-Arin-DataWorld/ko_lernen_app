...
final class ClozeTopicGroups {
  ...
  static const Map<String, ClozeTopicGroupId> _topicToGroup = {
    ...
    // C3-T4 (2026-09-16): Batch 29 A1 reinforcement introduces 3 new exact
    ...
    'Freundschaft': ClozeTopicGroupId.peopleRelationships,
    ...
    '직장 소통': ClozeTopicGroupId.workEducation,
