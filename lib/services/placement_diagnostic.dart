...
const placementDiagnosticQuestions = <PlacementDiagnosticQuestion>[
  ...
  PlacementDiagnosticQuestion(
    ...
    korean: '현우 씨가 늦는다고 했어요.',
    choicesDe: [
      'Hyunwoo sagte, dass er zu spät kommt.',
      'Hyunwoo kommt immer früh.',
      'Ich sagte Hyunwoo, er soll warten.',
      'Hyunwoo arbeitet heute nicht.',
    ],
    choicesEn: [
      'Hyunwoo said that he will be late.',
      'Hyunwoo always arrives early.',
      'I told Hyunwoo to wait.',
      'Hyunwoo is not working today.',
    ],
    correctIndex: 0,
  ),
  PlacementDiagnosticQuestion(
