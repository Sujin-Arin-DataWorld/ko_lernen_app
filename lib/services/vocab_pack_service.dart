...
class VocabPackService {
  ...
  static const Map<String, (String, String)> packDisplayMap = {
    ...
    'a2_partner_house_entry': ('Ins Haus kommen', 'Coming into the house'),
    'a2_partner_chuseok_basic': (
      'Erste Schritte an Chuseok',
      'First steps at Chuseok',
    ),
    'a2_partner_photo_thanks': ('Fotos und Dank', 'Photos and thanks'),
    'a2_pharmacy_ask': ('In der Apotheke fragen', 'Asking at the pharmacy'),
    'a2_school_supplies': ('Sachen für den Kurs', 'Class supplies'),
    'a2_subway_card': ('U-Bahn-Karte', 'Subway card'),
    'a2_weather_layer': ('Der Witterung anziehen', 'Dressing for the weather'),
    'b1_work_entry_2026': (
      'Berufseinstieg & Arbeitsbedingungen',
      'Starting Work & Conditions',
    ),
    'b1_neighbors_hall': ('Nachbarn im Flur', 'Neighbors in the hall'),
    'b1_partner_first_gift': (
      'Das erste Besuchgeschenk',
      'The first visit gift',
    ),
    'b1_partner_siblings_hello': (
      'Geschwister zum ersten Mal',
      'Meeting the siblings',
    ),
    'b1_partner_sibling_tease': (
      'Geschwisterscherze',
      'Sibling teasing and backup',
    ),
    'b1_partner_banmal_switch': (
      'Zwischen Banmal und Höflichkeit',
      'Between casual and honorific speech',
    ),
    'b1_bank_counter': ('Am Bankschalter', 'Bank counter'),
    'b1_housing_search_2026': (
      'Wohnungssuche & Vertrag',
      'Finding a Home & Contracts',
    ),
    'b1_part_time': ('Nebenjob', 'Part-time job'),
    'b1_phone_plan': ('Handytarif', 'Phone plan'),
    'b1_lost_found': ('Fundsachen', 'Lost and found'),
    'b1_festival_booth': ('Feststand', 'Festival booth'),
    'b1_apt_rules': ('Hausordnung', 'Apartment rules'),
    'b1_partner_leftover_bags': ('Eingepackte Reste', 'Leftovers packed to go'),
    'b2_housing_migration_2026': (
      'Wohnkosten, Migration & Teilhabe',
      'Housing, Migration & Inclusion',
    ),
    'b2_public_office': ('Gang zum Amt', 'Public office errand'),
  ...
  static const Map<String, int> packOrderInLevel = {
    ...
    'a2_partner_dinner_talk': 34,
    'a2_partner_seollal_day': 35,
    'a2_partner_chuseok_day': 37,
    'a2_partner_overnight': 40,
    'a2_partner_hometown_trip': 42,
    'b1_partner_awkward_questions': 23,
    'b1_partner_job_visa': 24,
    'b1_partner_translating': 25,
    'b1_partner_drink_table': 26,
    'b1_partner_sleep_room': 27,
    'b1_partner_after_visit': 28,
    'b1_partner_group_chat': 30,
    'b1_partner_holiday_plan': 31,
    ...
    'a2_gym_class': 46,
    'a2_salon_visit': 47,
    'b1_workplace_mail': 34,
    'b1_roommate_talk': 35,
    'b1_insurance_claim': 36,
    'b1_volunteer_shift': 38,
    'b1_parent_school': 39,
    'b1_repair_words': 40,
    'b1_travel_change': 41,
    ...
    'a2_pharmacy_ask': 53,
    'a2_school_supplies': 54,
    'a2_subway_card': 55,
    'a2_weather_layer': 56,
    'b1_work_entry_2026': 42,
    'b1_neighbors_hall': 43,
    'b1_partner_first_gift': 21,
    'b1_partner_siblings_hello': 22,
    'b1_partner_sibling_tease': 32,
    'b1_partner_banmal_switch': 33,
    'b1_bank_counter': 44,
    'b1_housing_search_2026': 45,
    'b1_part_time': 46,
    'b1_phone_plan': 47,
    'b1_lost_found': 48,
    'b1_festival_booth': 49,
    'b1_apt_rules': 50,
    'b1_partner_leftover_bags': 29,
