...
class VocabPackService {
  ...
  static const Map<String, (String, String)> packDisplayMap = {
    ...
    'a2_partner_dinner_talk': ('Gespraech am Abendessen', 'Talk at the family dinner'),
    ...
    'a2_partner_overnight': ('Ueber Nacht bleiben', 'Staying overnight'),
    ...
    'a2_partner_banmal_switch': ('Zwischen Banmal und Hoeflichkeit', 'Between casual and honorific speech'),
    'b1_partner_awkward_questions': ('Unangenehme Fragen parieren', 'Deflecting awkward questions'),
    'b1_partner_job_visa': ('Arbeit und Aufenthalt erklaeren', 'Explaining work and stay'),
    'b1_partner_translating': ('Das uebersetzende Paar', 'The partner who interprets'),
    'b1_partner_drink_table': ('Manieren am Trinktisch', 'Manners at the drinking table'),
    'b1_partner_sleep_room': ('Schlafplatz und Zimmgrenze', 'Sleeping place and room boundaries'),
    ...
    'b1_partner_holiday_plan': ('Feiertagsplaene abstimmen', 'Coordinating holiday plans'),
    'b2_partner_inlaws': ('Zwischen Schwiegerfamilien', 'Between the two in-law houses'),
    'b2_partner_marriage_talk': ('Heiratsgespraeche fuehren', 'Handling marriage talk'),
    ...
    'b2_partner_public_intro': ('Die Familie in der Oeffentlichkeit vorstellen', 'Introducing family in public'),
