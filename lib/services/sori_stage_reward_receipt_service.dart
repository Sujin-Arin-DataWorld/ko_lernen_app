...
abstract final class SoriStageRewardReceiptService {
  ...
  static RewardReceipt compare({
    ...
    _appendDelta(
      ...
      label: const SoriLocalizedCopy(de: 'Dojang-Stempel', en: 'Dojang stamp'),
    );
    _appendDelta(
      items,
    ...
    _appendDelta(
      ...
      label: const SoriLocalizedCopy(de: 'Bojagi', en: 'Bojagi'),
    );
    return RewardReceipt(
      activityId: activityId,
      receiptId:
          receiptId ?? '$activityId-${DateTime.now().microsecondsSinceEpoch}',
