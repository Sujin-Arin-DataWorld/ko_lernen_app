...
extension ScenarioBackdrop on Scenario {
  static const _categoryById = <String, String>{
    ...
    // Reviewed scenario Batch 10. Existing backdrop pipeline only.
    'a1_post_queue': 'pharmacy',
    'a1_stamp_ask': 'pharmacy',
    'a1_parcel_weight': 'station',
    'a1_pharmacy_ointment': 'pharmacy',
    'a1_mask_pack': 'pharmacy',
    'a1_weekend_rain': 'home',
    'a1_late_text': 'home',
    'a1_neighbor_box': 'home',
    'a1_hall_shoes': 'home',
    'a1_class_pencil': 'office',
    'a1_submit_name': 'office',
    'a1_subway_exit': 'station',
    'a1_last_train': 'station',
    'a1_card_topup': 'station',
    'a1_weather_layer': 'home',
    'a1_dust_mask': 'convenience',
    'a1_sorry_late': 'cafe',
    'a1_thanks_seat': 'station',
    'a1_slow_speech': 'cafe',
    'a1_door_bell': 'home',
    'a1_trash_sort': 'home',
    'a1_gate_code': 'home',
    'a1_whiteboard_word': 'office',
    'a1_platform_line': 'station',
    'a1_rain_jacket': 'convenience',
    'a1_excuse_pass': 'market',
    'a1_ask_again': 'cafe',
    'a1_meet_station': 'station',
    'a1_cancel_walk': 'home',
    'a1_floor_number': 'home',
    'a1_locker_key': 'office',
    'a1_bus_late': 'station',
    'a1_water_shop': 'convenience',
    'a1_tea_order': 'cafe',
    'a1_taxi_address': 'taxi',
    'a1_hotel_key': 'hotel',
    'a1_market_bag': 'market',
    'a1_airport_cart': 'airport',
    'a1_rice_shop': 'restaurant',
    'a1_direction_left': 'directions',
    'a1_office_print': 'office',
    'a1_cafe_wifi': 'cafe',
    'a1_station_rest': 'station',
    'a1_home_light': 'home',
    'a1_pharmacy_hours': 'pharmacy',
    'a2_phone_plan': 'office',
    'a2_data_roam': 'office',
    ...
    'a2_night_pay': 'office',
    'a2_lost_wallet': 'station',
    'a2_found_umbrella': 'station',
    'a2_festival_stamp': 'market',
    ...
    'a2_volunteer_vest': 'market',
    'a2_tea_taste': 'market',
    'a2_contract_read': 'office',
    'a2_recycle_box': 'home',
    'a2_card_balance': 'station',
    'a2_rain_cancel': 'home',
    'a2_guest_pass': 'home',
    'a2_manager_leave': 'office',
    'a2_label_phone': 'station',
    'a2_hours_six': 'market',
    'a2_seat_hold': 'cafe',
    'a2_water_set': 'home',
    'a2_front_desk': 'hotel',
    'a2_taxi_wait': 'taxi',
    'a2_airport_sim': 'airport',
    'a2_market_change': 'market',
    'a2_restaurant_split': 'restaurant',
    'a2_direction_bus': 'directions',
    'a2_convenience_copy': 'convenience',
    'a2_cafe_plug': 'cafe',
    'a2_hotel_late': 'hotel',
    'a2_office_badge': 'office',
    'a2_station_lost': 'station',
    'b1_mail_cc': 'office',
    'b1_missing_file': 'office',
    'b1_quiet_exam': 'home',
    'b1_bill_split': 'home',
    'b1_claim_same_day': 'office',
    'b1_deductible': 'office',
    'b1_civil_ticket': 'office',
    'b1_extra_paper': 'office',
    'b1_volunteer_gap': 'market',
    'b1_parent_slot': 'office',
    'b1_repair_photo': 'home',
    'b1_return_visit': 'home',
    'b1_typhoon_change': 'station',
    'b1_refund_rule': 'station',
    'b1_followup_mail': 'office',
    'b1_guest_notice': 'home',
    'b1_scan_note': 'pharmacy',
    'b1_proxy_form': 'office',
    'b1_safety_vest': 'market',
    'b1_school_letter': 'home',
    'b1_quote_change': 'home',
    'b1_waitlist': 'station',
    'b1_intranet_form': 'office',
    'b1_laundry_turn': 'home',
    'b1_warranty_week': 'office',
    'b1_connecting': 'airport',
    'b1_case_status': 'office',
    'b1_pickup_delay': 'home',
    'b1_hotel_shift': 'hotel',
    'b1_taxi_receipt': 'taxi',
    'b1_market_claim': 'market',
    'b1_cafe_invoice': 'cafe',
    'b2_review_three': 'office',
    'b2_self_fail': 'office',
    'b2_certified_mail': 'office',
    'b2_restore_scope': 'home',
    'b2_source_check': 'office',
    'b2_hold_share': 'home',
    'b2_agenda_swap': 'office',
    'b2_quorum_wait': 'office',
    'b2_must_have': 'office',
    'b2_time_box': 'office',
    'b2_one_pager': 'office',
    'b2_assumption': 'office',
    'b2_next_level': 'office',
    'b2_case_id': 'office',
    'b2_limit_line': 'office',
    'b2_chart_axes': 'office',
    'b2_minutes_draft': 'office',
    'b2_evidence_date': 'home',
    'b2_selective_edit': 'home',
    'b2_public_question': 'office',
    'b2_counter_offer': 'office',
    'b2_metric_clear': 'office',
    'b2_on_site': 'home',
    'b2_cross_check': 'office',
    'b2_vacate_short': 'home',
    'b2_read_receipt': 'office',
    'b2_airport_reseat': 'airport',
    'b2_hotel_clause': 'hotel',
    'b2_taxi_escalate': 'taxi',
    'b2_market_source': 'market',
    'b2_cafe_brief': 'cafe',
    'b2_station_hold': 'station',
    'b2_pharmacy_claim': 'pharmacy',
    'b2_restaurant_note': 'restaurant',
    'b2_direction_risk': 'directions',
    'b2_convenience_scan': 'convenience',
    'c1_uncertainty': 'office',
    'c1_sample_bias': 'office',
    'c1_briefing_number': 'office',
    'c1_question_window': 'office',
    'c1_leading_item': 'office',
    'c1_relative_risk': 'office',
    'c1_access_time': 'office',
    'c1_speaking_slot': 'office',
    'c2_discourse_premise': 'office',
    'c2_passive_hide': 'office',
    'c2_mandate_edge': 'office',
    'c2_archive_gap': 'office',
    'c2_appeal_bot': 'office',
    'c2_trace_log': 'office',
    'c2_withdraw_deep': 'office',
    'c2_uneven_impact': 'office',
