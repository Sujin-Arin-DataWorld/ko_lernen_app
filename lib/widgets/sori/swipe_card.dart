  ...
  void _onPanUpdate(DragUpdateDetails details) {
    ...
    switch (_axis!) {
      case _DragAxis.horizontal:
        ...
        if (widget.enabled) {
          setState(() {
            _dx = _supportedHorizontalOffset(_dx + details.delta.dx);
          });
        } else {
          ...
          setState(() {
            _dx = _supportedHorizontalOffset(
      ...
      case _DragAxis.vertical:
        ...
        setState(() {
          _dy = _supportedVerticalOffset(_dy + details.delta.dy);
        });
    }
  }
          ...
          child: Transform.rotate(
            ...
            child: Transform.scale(
              ...
              child: Stack(
                children: [
                  widget.child,
                  if (widget.onSwipeRight != null && widget.rightBadge != null)
                    _Stamp(
                  ...
                  if (widget.onSwipeLeft != null && widget.leftBadge != null)
                    _Stamp(
                  ...
                  if (widget.onSwipeDown != null && widget.downBadge != null)
                    _Stamp(
