...
- [ ] **메인 홈 IA (계획만, 2026-08-19)**: 정본
  `docs/MAIN_HOME_CRITIQUE_PLAN_2026-08-19.md`. Today는 대시보드가 아니라
  마당+오늘 일 하나. 코드 착수는 Jin이 §6 네 항을 고른 뒤 PR H1(로더·추천
  fail-open)부터. 한옥 V1 연결·탭 아이콘 PNG·웹 랜딩은 그 문서 게이트.
