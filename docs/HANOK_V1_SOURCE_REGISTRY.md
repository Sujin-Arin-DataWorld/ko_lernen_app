...
이후 투명 socket 파이프라인에서 A1-05·06·07·08·09·10 QA 상태를 승인했다. A1-07의 두
...
checkerboard만 Recraft 0.3 credit으로 제거했다. A1-10도 동일한 fail-closed 수정으로
개판/지붕 바탕 geometry만 보존했다. 현재 BBANANA 정적 ledger 합계는 13.5 credit이다.
