...
- 받다: 수령 가능 명사(선물·편지·칭찬·치료, **위치**='결혼식 위치를 받았어요'). 흘리다: 사물(지갑을 흘리다=떨어뜨리다), 비밀·농담·칭찬(말을 흘리다=누설), 웃음(웃음을 흘리다).
...
| `cloze_a2_0455` | 치료 | batda | 치과에서 상처를 받고 있어요. | ✗(의미 불성립: 받을 수 없는 부류 -- 선물·편지·칭찬·치료·위치 정보 등 수령 가능 명사 제외) |
...
전수 읽기(64건 × 3 배분어, 저작 중 3회 반복) 결과 두 번째 유효 문장은 0건. 원어민 감각으로 **가장 약한** 조합 3건을 Jin 판단용으로 남긴다 (전부 '문법은 되지만 뜻이 안 통함' 쪽이며, 필요하면 교체 가능):
