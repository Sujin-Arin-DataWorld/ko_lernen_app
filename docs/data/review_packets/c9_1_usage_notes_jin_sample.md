...
- 전형 상황:
  - KO: 가족 안에서 형제자매의 순서를 설명하거나 애정 어린 별명처럼 부를 때 쓴다.
...
- 패턴:
    - KO: N네 막내
    - DE: das Nesthäkchen der Familie N
    - EN: the youngest child in N’s family
- 연어:
    - KO: 우리 집 막내
    - DE: unser Nesthäkchen
    - EN: the youngest in our family
    - KO: 막내로 태어나다
    - DE: als Jüngstes geboren werden
    - EN: to be born as the youngest
- 대조어:
  - 첫째 [vocabId: null]
...
- 전형 상황:
  - KO: 문제, 갈등, 어려움처럼 해결이 필요한 상황을 이야기할 때 쓴다.
...
- 패턴:
    - KO: N이/가 해결되다
    - DE: etwas wird gelöst
    - EN: something gets resolved
- 연어:
    - KO: 문제 해결
    - DE: Problemlösung
    - EN: problem solving
...
- 대조어:
  - 답 [vocabId: null]
    - KO: 해결은 문제를 풀어 나가는 일이나 그 결과를 가리키고, 답은 질문에 대한 대답이나 문제의 정답을 가리킨다.
    - DE: 해결 bezeichnet die Lösung eines Problems als Vorgang oder Ergebnis, 답 eine Antwort auf eine Frage oder Aufgabe.
    - EN: 해결 refers to solving a problem or its resolution, while 답 refers to an answer to a question or problem.
- 예문 2개:
  - [formal]
...
- 전형 상황:
  - KO: 행사나 프로젝트에 함께할 사람을 찾거나 참여 경험을 이야기할 때 쓴다.
  - DE: Man verwendet es, um Mitwirkende für Veranstaltungen oder Projekte zu suchen oder von der Teilnahme zu erzählen.
  - EN: It is used to invite people to join events or projects or to discuss participation experiences.
- 패턴:
    - KO: N에 참여하다
    - DE: an N teilnehmen
    - EN: to take part in N
- 연어:
    - KO: 행사에 참여하다
    - DE: an einer Veranstaltung teilnehmen
    - EN: to take part in an event
    - KO: 적극적으로 참여하다
    - DE: sich aktiv beteiligen
    - EN: to participate actively
- 대조어:
  - 참석하다 [vocabId: vocab_b1_0185]
    - KO: 참여하다는 활동에 함께하는 데, 참석하다는 회의나 행사에 나오는 데 초점을 두지만 둘 다 적극적으로 함께하는 상황에 쓸 수 있다.
    - DE: 참여하다 betont das Mitmachen, 참석하다 die Anwesenheit bei einem Termin; beide können aktive Beteiligung einschließen.
    - EN: 참여하다 emphasizes taking part, while 참석하다 emphasizes attending; either can involve active participation.
- 예문 2개:
  - [written]
...
- 전형 상황:
  - KO: 프로젝트의 흐름을 설명하거나 회의와 행사의 운영을 이야기할 때 쓴다.
  - DE: Man verwendet es, um den Verlauf eines Projekts oder die Durchführung eines Termins zu beschreiben.
  - EN: It is used to describe a project’s progress or the running of a meeting or event.
- 패턴:
    - KO: N을/를 진행하다
    - DE: etwas durchführen / vorantreiben
    - EN: to carry out / proceed with something
- 연어:
    - KO: 일정대로 진행하다
    - DE: planmäßig vorangehen
    - EN: to proceed on schedule
    - KO: 회의를 진행하다
    - DE: eine Sitzung leiten
    - EN: to run a meeting
- 대조어:
  - 실시하다 [vocabId: null]
    - KO: 진행하다는 일을 이어 가는 흐름이나 운영에, 실시하다는 조사나 시험, 제도 등을 실제로 시행하는 데 초점을 둔다.
    - DE: 진행하다 betont den Verlauf oder die Leitung, 실시하다 die tatsächliche Durchführung etwa einer Umfrage, Prüfung oder Maßnahme.
    - EN: 진행하다 focuses on progress or running something, while 실시하다 focuses on carrying out a survey, test, or measure.
- 예문 2개:
  - [formal]
...
- 전형 상황:
  - KO: 명절, 축제, 지역 문화처럼 오래 이어진 방식을 이야기할 때 쓴다.
...
- 연어:
    - KO: 전통을 지키다
    - DE: eine Tradition bewahren
    - EN: to keep a tradition
    - KO: 전통 문화
    - DE: traditionelle Kultur
    - EN: traditional culture
- 대조어:
  - 관습 [vocabId: null]
    - KO: 전통은 이어져 내려온 문화나 방식을, 관습은 사회에서 오래 정착되어 인정받는 관행을 가리키며 두 말의 쓰임은 겹칠 수 있다.
    - DE: 전통 betont überlieferte Kultur oder Vorgehensweisen, 관습 gesellschaftlich etablierte und anerkannte Bräuche oder Praktiken; die Verwendungen können sich überschneiden.
    - EN: 전통 emphasizes inherited culture or ways of doing things, while 관습 refers to long-established, socially recognized customs or practices; their uses can overlap.
- 예문 2개:
  - [formal]
...
- 전형 상황:
  - KO: 약국에서 두통에 쓸 약을 묻거나 두통약을 이야기할 때 쓴다.
  - DE: Man verwendet es etwa in der Apotheke, wenn man nach einem Mittel gegen Kopfschmerzen fragt.
  - EN: It is used, for example, at a pharmacy when asking about medicine for a headache.
- 패턴:
    - KO: 두통약이 있다/필요하다
    - DE: Kopfschmerztabletten haben / brauchen
    - EN: to have / need headache medicine
- 연어:
    - KO: 두통약을 먹다
    - DE: eine Kopfschmerztablette nehmen
    - EN: to take headache medicine
    - KO: 두통약을 사다
    - DE: Kopfschmerztabletten kaufen
    - EN: to buy headache medicine
- 대조어:
  - 진통제 [vocabId: vocab_b1_0160]
    - KO: 두통약은 머리가 아플 때 먹는 약을 구체적으로 가리키고, 진통제는 머리든 다른 부위든 통증 전체에 쓰는 더 넓은 말이다.
    - DE: 두통약 bezeichnet ein Mittel gegen Kopfschmerzen, 진통제 ist der allgemeinere Begriff für Schmerzmittel.
...
- 전형 상황:
  - KO: 가족이나 친구와 함께 식당에서 밥을 먹기로 할 때 쓴다.
...
- 패턴:
    - KO: 외식을 하다
    - DE: auswärts essen gehen
    - EN: to eat out
- 연어:
    - KO: 가족 외식
    - DE: Familienessen außer Haus
    - EN: family dinner out
    - KO: 외식 메뉴를 정하다
    - DE: entscheiden, was man auswärts essen möchte
...
- 패턴:
    - KO: 부동산에 가다
    - DE: zum Immobilienbüro gehen
    - EN: to go to a real estate agency
- 연어:
    - KO: 근처 부동산
    - DE: ein Immobilienbüro in der Nähe
    - EN: a nearby real estate agency
    - KO: 부동산에 문의하다
    - DE: beim Immobilienbüro nachfragen
    - EN: to ask a real estate agency
- 대조어:
  - 집 [vocabId: vocab_a1_0019]
    - KO: 부동산은 집이나 땅 같은 재산을 뜻하고 일상에서는 중개소를 가리키기도 하며, 집은 주거 공간이나 건물 자체를 뜻한다.
    - DE: 부동산 bezeichnet Immobilien oder umgangssprachlich ein Maklerbüro, 집 das Zuhause oder Wohngebäude selbst.
    - EN: 부동산 refers to real estate or, colloquially, an estate agency, while 집 refers to the home or residential building itself.
- 예문 2개:
  - [formal]
...
- 전형 상황:
  - KO: 경찰이나 보험사, 서비스 센터 등에서 사고 내용을 받아 처리할 때 쓴다.
  - DE: Man verwendet es etwa bei Polizei, Versicherung oder Servicezentren für die Aufnahme einer Unfallmeldung.
  - EN: It is used when police, insurers, or service centers receive accident reports.
- 패턴:
    - KO: 사고 접수를 하다
    - DE: einen Unfall melden
    - EN: to submit an accident report
- 연어:
    - KO: 사고 접수 번호
    - DE: Vorgangsnummer der Unfallmeldung
    - EN: accident report reference number
    - KO: 온라인으로 사고 접수하다
    - DE: einen Unfall online melden
    - EN: to report an accident online
- 대조어:
  - 신고 [vocabId: vocab_c1_0214]
    - KO: 사고 접수는 사고 내용을 받아 기록하는 처리 단계에, 신고는 사고나 사건 등을 담당 기관에 알리는 행위에 초점을 둔다.
    - DE: 사고 접수 betont die Aufnahme einer Unfallmeldung, 신고 das Melden eines Unfalls oder anderen Vorfalls bei einer zuständigen Stelle.
    - EN: 사고 접수 focuses on receiving and recording an accident report, while 신고 focuses on reporting an accident or other incident to the responsible organization.
- 예문 2개:
  - [formal]
...
- 전형 상황:
  - KO: 채용 과정에서 면접 날짜나 시간을 확인하고 조율할 때 쓴다.
...
- 패턴:
    - KO: 면접 일정을 잡다
    - DE: einen Vorstellungstermin vereinbaren
    - EN: to schedule an interview
- 연어:
    - KO: 면접 일정 변경
    - DE: Änderung des Vorstellungstermins
    - EN: interview schedule change
    - KO: 면접 일정을 확인하다
    - DE: den Vorstellungstermin bestätigen
    - EN: to confirm the interview schedule
- 대조어:
  - 일정 [vocabId: vocab_b1_0072]
