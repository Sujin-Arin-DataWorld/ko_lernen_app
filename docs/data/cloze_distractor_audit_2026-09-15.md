...
Live corpus: `assets/data/cloze.json`, 2151 items, 6 levels. Rules D1-D6 per `tools/content_factory/cloze_distractor_rules.py`. D5 is detection only (needs a human/LLM read); D7 is the umbrella judgement rule, not separately audited.
