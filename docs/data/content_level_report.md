...
| 앱 레벨 | A1 | A2 | B1 | B2 | C1 | C2 | 미검출 | 합계 |
|---|---|---|---|---|---|---|---|---|
| a1 | 271 | 47 | 11 | 0 | 2 | 0 | 0 | 331 |
| a2 | 99 | 133 | 33 | 9 | 2 | 0 | 0 | 276 |
| b1 | 53 | 183 | 141 | 55 | 3 | 1 | 0 | 436 |
| b2 | 14 | 90 | 159 | 127 | 19 | 7 | 0 | 416 |
| c1 | 0 | 22 | 80 | 137 | 10 | 1 | 0 | 250 |
| c2 | 0 | 19 | 72 | 135 | 17 | 7 | 0 | 250 |

### satz (targetKo)

| 앱 레벨 | A1 | A2 | B1 | B2 | C1 | C2 | 미검출 | 합계 |
|---|---|---|---|---|---|---|---|---|
| a1 | 268 | 41 | 7 | 1 | 1 | 0 | 0 | 318 |
| a2 | 214 | 197 | 34 | 9 | 0 | 0 | 0 | 454 |
| b1 | 154 | 268 | 151 | 53 | 4 | 0 | 0 | 630 |
...
| `a1_city_services_2026_1` | a1 | 10 | 10 | 0 | 0% | 0 | keep |
...
| `a1_misc_1` | a1 | 10 | 10 | 0 | 0% | 0 | keep |
| `a1_misc_2` | a1 | 12 | 12 | 0 | 0% | 0 | keep |
| `a1_numbers_1` | a1 | 12 | 12 | 0 | 0% | 0 | keep |
| `a1_numbers_2` | a1 | 12 | 12 | 0 | 0% | 0 | keep |
| `a1_numbers_3` | a1 | 12 | 12 | 0 | 0% | 0 | keep |
| `a1_particles_in_use_1` | a1 | 11 | 11 | 0 | 0% | 0 | keep |
| `a1_partner_meet_names_1` | a1 | 11 | 9 | 0 | 0% | 0 | keep |
| `a1_partner_seollal_basic_1` | a1 | 12 | 12 | 0 | 0% | 0 | keep |
| `a1_partner_table_basic_1` | a1 | 12 | 10 | 1 | 0% | 0 | keep |
| `a1_payment_delivery_1` | a1 | 12 | 12 | 0 | 0% | 0 | keep |
| `a1_position` | a1 | 12 | 12 | 0 | 0% | 0 | keep |
| `a1_post_office_1` | a1 | 12 | 12 | 0 | 0% | 0 | keep |
| `a1_repair_language_1` | a1 | 10 | 10 | 0 | 0% | 0 | keep |
| `a1_self_intro` | a1 | 12 | 12 | 0 | 0% | 0 | keep |
| `a1_sorry_thanks_1` | a1 | 12 | 12 | 0 | 0% | 0 | keep |
| `a1_time_1` | a1 | 12 | 12 | 0 | 0% | 0 | keep |
...
- 고유 표제어: 714 · 앱 보유(레벨 무관): 457 · 목표 레벨 일치: 295 · 결손: 257

- **감탄사** (1): 그래
- **관형사** (11): 마흔, 무슨, 백만, 서른, 십만, 아흔, 어떤, 억, 여든, 여러, 일흔
- **대명사** (8): 그, 그쪽, 내, 무엇, 뭐, 어디, 이쪽, 저쪽
- **동사** (30): 걸다, 그리다, 끄다, 나다, 넣다, 놀다, 다녀오다, 돌아가다, 돌아오다, 되다, 들어가다, 들어오다, 말다, 맞다, 못하다, 묻다, 불다, 시키다, 알리다, 올라가다, 울다, 잘하다, 지나다, 지내다, 찍다, 찾아보다, 추다, 춤추다, 치다, 피우다
- **명사** (156): 가요, 가운데, 갈비, 갈비탕, 감, 감기, 개, 건너편, 건물, 게임, 계속, 고양이, 곳, 교통, 구경, 구월, 그림, 극장, 근처, 글, 기분, 기숙사, 김밥, 김치찌개, 꽃, 나무, 나중, 남대문, 남산, 노래, 노래방, 농구, 달, 담배, 대사관, 동대문, 동안, 된장찌개, 드라마, 등산, 떡볶이, 러시아, 말레이시아, 메뉴, 모두, 목욕탕, 몽골, 미국, 밑, 바다, 바지, 방학, 백화점, 베트남, 병, 볼펜, 부산, 사무실, 사월, 사이다, 산, 산책, 삼계탕, 삼월, 생일, 생활, 샤워, 서울, 서점, 세수, 쇼핑, 수영, 수영장, 수첩, 술, 슈퍼마켓, 스키, 시월, 식사, 신문, 십이월, 십일월, 아기, 아르바이트, 아이, 아파트, 야구, 에어컨, 여권, 여행사, 연극, 영, 영국, 영화관, 영화배우, 오렌지, 오월, 오전, 오후, 외국, 외국어, 요즘, 운동장, 운동화, 운전, 월, 유명, 유월, 음료수, 이번, 이야기, 이월, 인도네시아, 인천, 일본, 일월, 일주일, 잠, 잡채, 장소, 제일, 제주도, 종업원, 주, 주일, 중국, 지난달, 지난주, 지난해, 참외, 천만, 축구, 춤, 층, 칠월, 카메라, 캐나다, 커피숍, 콘서트, 콜라, 키, 탁구, 태국, 태권도, 터미널, 테니스, 텔레비전, 티셔츠, 파티, 팔월, 포도, 프랑스, 프로그램, 피아노, 학생증, 후
