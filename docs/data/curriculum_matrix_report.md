...
## 0. 매트릭스 요구와 검수된 Phase 과제 경로

> 모든 행은 KO 매트릭스의 레벨 × 축 × R/P 요구사항이다. `contentCandidates`와 뒤의 갭 표는 기존 콘텐츠 탐색 결과이며 콘텐츠 부재의 증명이 아니다. `taskBindings`는 별도 검수·해시 검증을 거친 Phase 자료·연습·문항 연결이다. 문항은 요구의 표본이며, 경로 계약은 기기 실행 결과가 아니다. 자유 응답과 전체 숙달은 미검증으로 유지한다.
...
| A1 | speechAct | `A1:speechAct:express_intention_plan_wish:P` | P | scenario:a1_theme_park_date_choices, scenario:survival_day_capstone, unit:a1_16_survival_capstone | no_approved_semantic_binding | `phase_task_path_connected` | KP03:production:05 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| A1 | speechAct | `A1:speechAct:narrate_experience_events:P` | P | scenario:a1_w10_fandom | no_approved_semantic_binding | `phase_task_path_connected` | KP02:speaking:02 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| A1 | speechAct | `A1:speechAct:describe_people_things_places:P` | P | scenario:korea_stay_smalltalk | no_approved_semantic_binding | `phase_task_path_connected` | KP02:speaking:02, KP04:speaking:02 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| A1 | speechAct | `A1:speechAct:suggest_propose:P` | P | scenario:a1_theme_park_date_choices | no_approved_semantic_binding | `phase_task_path_connected` | KP03:speaking:02 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| A1 | speechAct | `A1:speechAct:express_feelings_emotions:P` | P | scenario:korea_stay_smalltalk | no_approved_semantic_binding | `phase_task_path_connected` | KP04:speaking:02 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
...
| A1 | textType | `A1:textType:song_lyric_line:R` | R | media:media_001, media:media_002, media:media_003, media:media_004, media:media_005, media:media_006 … | no_approved_semantic_binding | `phase_task_path_connected` | KP04:listening:02 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| A1 | textType | `A1:textType:phone_call:R` | R | scenario:a1_w10_phone, smalltalk:smalltalk_a1_0050, smalltalk:smalltalk_a1_0051, smalltalk:smalltalk_a1_0052, smalltalk:smalltalk_a1_0053, smalltalk:smalltalk_a1_0089 | no_approved_semantic_binding | `phase_task_path_connected` | KP02:listening:02 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| A1 | textType | `A1:textType:dialogue_face_to_face:P` | P | — | no_approved_semantic_binding | `phase_task_path_connected` | KP01:speaking:02, KP04:speaking:01 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| A1 | textType | `A1:textType:service_encounter_counter:P` | P | — | no_approved_semantic_binding | `phase_task_path_connected` | KP03:speaking:01 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
...
| A2 | textType | `A2:textType:written_notice_announcement:R` | R | — | no_approved_semantic_binding | `phase_task_path_connected` | KP05:reading:01, KP08:reading:01 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| A2 | textType | `A2:textType:advertisement_leaflet:R` | R | — | no_approved_semantic_binding | `phase_task_path_connected` | KP05:reading:02 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| A2 | textType | `A2:textType:instructions_manual_recipe:R` | R | — | no_approved_semantic_binding | `phase_task_path_connected` | KP05:reading:03, KP08:reading:01 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| A2 | textType | `A2:textType:drama_film_line:R` | R | media:media_025, media:media_026, media:media_027, media:media_028, media:media_029, media:media_030 … | no_approved_semantic_binding | `phase_task_path_connected` | KP08:listening:02 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| A2 | textType | `A2:textType:email_informal:R` | R | — | no_approved_semantic_binding | `phase_task_path_connected` | KP06:reading:01 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| A2 | textType | `A2:textType:explanatory_informational_text:R` | R | — | no_approved_semantic_binding | `phase_task_path_connected` | KP06:reading:02, KP07:reading:01 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| A2 | textType | `A2:textType:phone_call:R` | R | scenario:a2_w10_booking, smalltalk:smalltalk_a2_0049, smalltalk:smalltalk_a2_0050, smalltalk:smalltalk_a2_0051, smalltalk:smalltalk_a2_0052 | no_approved_semantic_binding | `phase_task_path_connected` | KP07:listening:02 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| A2 | textType | `A2:textType:email_informal:P` | P | — | no_approved_semantic_binding | `phase_task_path_connected` | KP06:writing:02, KP08:writing:02 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| A2 | textType | `A2:textType:instant_message_chat:P` | P | — | no_approved_semantic_binding | `phase_task_path_connected` | KP05:writing:02, KP07:writing:02 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
...
| B1 | textType | `B1:textType:social_media_post_comment:R` | R | — | no_approved_semantic_binding | `phase_task_path_connected` | KP09:reading:01, KP11:reading:03 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| B1 | textType | `B1:textType:email_letter_formal:R` | R | — | no_approved_semantic_binding | `phase_task_path_connected` | KP12:reading:01, KP13:reading:02 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| B1 | textType | `B1:textType:presentation_briefing_talk:P` | P | — | no_approved_semantic_binding | `phase_task_path_connected` | KP11:speaking:02, KP13:speaking:02 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| B1 | textType | `B1:textType:job_interview:P` | P | — | no_approved_semantic_binding | `phase_task_path_connected` | KP09:speaking:02, KP12:speaking:02 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| B1 | textType | `B1:textType:email_letter_formal:P` | P | — | no_approved_semantic_binding | `phase_task_path_connected` | KP12:writing:01 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
...
| B2 | textType | `B2:textType:presentation_briefing_talk:P` | P | — | no_approved_semantic_binding | `phase_task_path_connected` | KP14:speaking:01, KP18:speaking:01 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
...
| C1 | textType | `C1:textType:report_proposal_official:R` | R | — | no_approved_semantic_binding | `phase_task_path_connected` | KP19:reading:02, KP22:reading:01 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| C1 | textType | `C1:textType:news_article_report:R` | R | — | no_approved_semantic_binding | `phase_task_path_connected` | KP20:reading:01, KP23:reading:01 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| C1 | textType | `C1:textType:contract_terms_legal_text:R` | R | — | no_approved_semantic_binding | `phase_task_path_connected` | KP21:reading:01, KP22:reading:01 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| C1 | textType | `C1:textType:report_proposal_official:P` | P | — | no_approved_semantic_binding | `phase_task_path_connected` | KP19:writing:01, KP22:writing:01, KP23:writing:01 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| C1 | textType | `C1:textType:essay_opinion_argumentative:P` | P | — | no_approved_semantic_binding | `phase_task_path_connected` | KP21:writing:01, KP24:writing:01 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
...
| C2 | speechAct | `C2:speechAct:persuade_argue_justify:P` | P | scenario:c2_w10_fandom, scenario:c2_w10_impact, scenario:protest_order_and_rights, unit:c2_01_interpretation_institutions, unit:c2_02_technology_public_ethics, unit:c2_04_sanction_accountability … | no_approved_semantic_binding | `phase_task_path_connected` | KP27:writing:01, KP29:writing:01 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| C2 | speechAct | `C2:speechAct:express_certainty_doubt_hedging:P` | P | scenario:automated_benefit_denial, scenario:climate_model_local_decision, scenario:diaspora_name_identity, scenario:family_memory_conflict, scenario:medical_uncertainty_consent, scenario:passive_voice_accountability … | no_approved_semantic_binding | `phase_task_path_connected` | KP29:speaking:01 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| C2 | speechAct | `C2:speechAct:summarise_reconstruct:P` | P | scenario:c2_w10_record, scenario:central_local_disaster_responsibility | no_approved_semantic_binding | `phase_task_path_connected` | KP25:writing:01, KP30:writing:01 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| C2 | speechAct | `C2:speechAct:manage_turns_interrupt_hold_floor:P` | P | — | no_approved_semantic_binding | `phase_task_path_connected` | KP28:speaking:01 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| C2 | speechAct | `C2:speechAct:negotiate_compromise_conditions:P` | P | scenario:c2_w10_friends, scenario:emergency_price_controls, scenario:relationship_story_reframing, unit:c2_05_relationship_narratives | no_approved_semantic_binding | `phase_task_path_connected` | KP27:speaking:01 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| C2 | speechAct | `C2:speechAct:compare_contrast_alternatives:P` | P | scenario:causal_claim_headline, scenario:climate_model_local_decision, scenario:family_memory_conflict, scenario:medical_uncertainty_consent, scenario:poll_question_framing, scenario:protest_order_and_rights … | no_approved_semantic_binding | `phase_task_path_connected` | KP27:writing:01, KP30:writing:01 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| C2 | textType | `C2:textType:academic_specialised_text:R` | R | — | no_approved_semantic_binding | `phase_task_path_connected` | KP25:reading:02, KP29:reading:02 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| C2 | textType | `C2:textType:literary_text:R` | R | — | no_approved_semantic_binding | `phase_task_path_connected` | KP26:reading:01, KP28:reading:02, KP29:reading:01, KP30:reading:01 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| C2 | textType | `C2:textType:lecture_speech_monologue:R` | R | — | no_approved_semantic_binding | `phase_task_path_connected` | KP27:listening:02, KP30:listening:02 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| C2 | textType | `C2:textType:news_article_report:R` | R | — | no_approved_semantic_binding | `phase_task_path_connected` | KP26:reading:02, KP28:reading:01 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| C2 | textType | `C2:textType:contract_terms_legal_text:R` | R | — | no_approved_semantic_binding | `phase_task_path_connected` | KP25:reading:01, KP30:reading:02 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| C2 | textType | `C2:textType:essay_opinion_argumentative:R` | R | — | no_approved_semantic_binding | `phase_task_path_connected` | KP27:reading:01 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| C2 | textType | `C2:textType:essay_opinion_argumentative:P` | P | — | no_approved_semantic_binding | `phase_task_path_connected` | KP26:writing:01, KP27:writing:01, KP29:writing:01 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| C2 | textType | `C2:textType:report_proposal_official:P` | P | — | no_approved_semantic_binding | `phase_task_path_connected` | KP25:writing:01, KP30:writing:01 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| C2 | textType | `C2:textType:review_critique_text:P` | P | — | no_approved_semantic_binding | `phase_task_path_connected` | KP26:writing:01, KP30:writing:01 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
...
| C2 | register | `C2:register:written_plain_haeche:P` | P | — | no_approved_semantic_binding | `phase_task_path_connected` | KP25:writing:01, KP26:writing:01, KP27:writing:01, KP29:writing:01, KP30:writing:01 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| C2 | register | `C2:register:hage_familiar:R` | R | — | no_approved_semantic_binding | `phase_task_path_connected` | KP30:listening:01 · 문항/경로 계약 연결 · 전체 숙달 미검증 |
| C2 | register | `C2:register:hao_semiformal:R` | R | — | no_approved_semantic_binding | `phase_task_path_connected` | KP30:listening:01 · 문항/경로 계약 연결 · 전체 숙달 미검증 |

## 1. 기존 앱 인벤토리 및 후보 매칭 (학습 완료 판정 아님)

- 콘텐츠 규모: 어휘 2754 · 문법 252 · 시나리오 178 · 코스유닛 48 · cloze 2151 · satz 2671 · 스몰토크 582 · 미디어 136 · 발음 84 · 문화노트 36
...
|---|---|---|---|---|---|---|---|---|---|
| ✅ covered | `communication_phone_digital` 전화·메신저·인터넷 소통 | 전화번호·연락 방법 정하기 | 7 | 4 | 2 | 1 | 5 | 6 | model_knowledge |
| ✅ covered | `daily_life_routines` 일상생활·하루 일과 | 하루 일과·주말 활동·과거 활동 | 79 | 10 | 2 | 3 | 6 | 67 | verified_repo |
| ✅ covered | `education_study` 교육·학교·학습 | 학교·수업·학용품(명사 수준) | 27 | 7 | 3 | 1 | 2 | 24 | model_knowledge |
| ✅ covered | `family_relationships` 가족·인간관계 | 가족 소개·가족 높임 기초 | 62 | 6 | 4 | 1 | 30 | 60 | verified_repo |
| ✅ covered | `feelings_character` 감정·성격·외모 묘사 | 외모·사물 묘사·대조(간단 형용사) | 27 | 5 | 1 | 0 | 4 | 13 | verified_repo |
| ✅ covered | `food_drink` 식음료·식당 | 음식 취향·식당 주문·수량 | 41 | 4 | 6 | 2 | 5 | 33 | verified_repo |
| ✅ covered | `free_time_hobbies_sport` 여가·취미·운동 | 취미·주말 약속 제안 | 41 | 8 | 2 | 0 | 16 | 39 | verified_repo |
| ✅ covered | `health_body` 건강·신체·병원·약국 | 신체 부위·아픈 곳 한 단어·결석 사유 | 19 | 2 | 3 | 1 | 10 | 19 | verified_repo |
| ✅ covered | `house_home` 주거·집 | 집·방·물건 위치(앞/뒤/위/안) | 15 | 5 | 7 | 2 | 2 | 9 | verified_repo |
| ✅ covered | `language_learning_communication_repair` 언어·학습·의사소통 되묻기 | 못 들었을 때 다시 묻기·천천히 말해 달라고 하기 | 10 | 3 | 3 | 3 | 0 | 22 | verified_repo |
| ✅ covered | `numbers_time_dates` 숫자·시간·날짜 | 숫자·전화번호·화폐·날짜·요일·시간 | 103 | 12 | 2 | 1 | 0 | 81 | verified_repo |
...
| ✅ covered | `weather_nature_climate` 날씨·계절·자연 | 날씨·계절 말하기와 간단한 추측 | 8 | 1 | 3 | 0 | 3 | 8 | verified_repo |
| ✅ covered | `work_career` 직업·직장·취업 | 직업 이름·직장 위치(명사 수준) | 4 | 3 | 0 | 1 | 6 | 3 | model_knowledge |
...
| ✅ optional_covered | `neighbourhood_environment` 동네·이웃·주변 환경 | 도시 생활 어휘(동네·이웃 명사) | 20 | 2 | 0 | 0 | 0 | 14 | verified_repo |
...
| ➕ beyond_matrix | `technology_digital_ai` 기술·디지털·AI·데이터 |  | 7 | 4 | 0 | 0 | 0 | 7 |  |

### A1 문법 — 국제통용 45항목: match 45 · level_mismatch 0 · missing 0 (앱 A1 문법 55개)
...
| 상태 | 어휘 영역 | 단어 수 |
|---|---|---|
| ✅ covered | `numbers_quantity_units` 수·수량·단위명사 | 103 |
| ✅ covered | `time_calendar` 시간·날짜·요일·계절 | 79 |
| ✅ covered | `colours_shapes_description` 색·모양·기본 묘사 형용사 | 19 |
| ✅ covered | `body_health_symptoms` 신체·증상·의료 | 19 |
| ✅ covered | `family_kinship_address_terms` 가족·친족 호칭·관계어 | 62 |
| ✅ covered | `food_cooking` 음식·재료·조리 | 41 |
| ✅ covered | `home_objects_furniture` 집·가구·생활용품 | 15 |
| ✅ covered | `places_buildings_city` 장소·건물·도시 | 35 |
| ✅ covered | `transport_travel_vocab` 교통·여행 어휘 | 12 |
| 🟡 thin | `professions_workplace` 직업·직장 어휘 | 4 |
| ✅ covered | `school_study_terms` 학교·학습 어휘 | 27 |
| ✅ covered | `weather_nature` 날씨·자연 어휘 | 8 |
...
| 상태 | 주제 | 초점(매트릭스) | 단어 | 팩 | 시나리오 | 유닛 | 스몰토크 | cloze | 근거 출처 |
|---|---|---|---|---|---|---|---|---|---|
| ✅ covered | `daily_life_routines` 일상생활·하루 일과 | 습관·생활 문제 | 39 | 4 | 0 | 0 | 4 | 21 | model_knowledge |
...
| ✅ covered | `family_relationships` 가족·인간관계 | 인간관계·감정 확인·관계 갈등 | 165 | 16 | 4 | 0 | 30 | 169 | model_knowledge |
| ✅ covered | `feelings_character` 감정·성격·외모 묘사 | 감정과 관계 완곡 표현 | 58 | 7 | 6 | 1 | 4 | 5 | model_knowledge |
...
| 상태 | 어휘 영역 | 단어 수 |
|---|---|---|
| ✅ covered | `professions_workplace` 직업·직장 어휘 | 80 |
...
| ✅ covered | `feelings_emotions_character` 감정·성격 어휘 | 58 |
| 🟡 thin | `language_metalanguage` 언어·문법·화법 메타언어 | 7 |
...
| 상태 | 어휘 영역 | 단어 수 |
|---|---|---|
| ✅ covered | `society_economy_abstract_nouns` 사회·경제·추상 명사 | 132 |
...
| ➕ beyond_matrix | `school_study_terms` 학교·학습 어휘 | 22 |
