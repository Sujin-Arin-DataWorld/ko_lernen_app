...
**레벨 불일치(앱은 다른 레벨에 둠):** 같이→A2 · -고 나다→A2 · -기 위해→A2 · -는 대신에→B2 · -어 가지고→A2 · -어 드리다→A2 · -어지다→A2 · -으면 안 되다→A2 · -으면 좋겠다→A2
...
| ✅ match | -(으)ㄴ/는 대신에 | B1 | grammar_b2_instead_tradeoff | B2 |
...
| ❌ missing | -다는 측면에서 | — |  |  |
| 🟡 level_mismatch | -기에 앞서 | C1 | grammar_b2_reasoned_perspective | B2 |
