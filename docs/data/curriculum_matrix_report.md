...
| B1 | 18/0/0 | 13/8/46 (of 67) | 7/10/4 | 4/0 | 11/3/1 | 1/0/2/6 | 8/1/0 | 4/0 | 28/39 |
...
### B1 문법 — 국제통용 67항목: match 13 · level_mismatch 8 · missing 46 (앱 B1 문법 39개)
...
**레벨 불일치(앱은 다른 레벨에 둠):** 같이→A2 · -고 나다→A2 · -기 위해→A2 · -어 가지고→A2 · -어 드리다→A2 · -어지다→A2 · -으면 안 되다→A2 · -으면 좋겠다→A2
