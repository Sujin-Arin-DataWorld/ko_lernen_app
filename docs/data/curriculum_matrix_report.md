...
- 갭 행 합계: **523** (`tool/curriculum_matrix_gaps.csv`)
...
| ➕ beyond_matrix | `technology_digital_ai` 기술·디지털·AI·데이터 |  | 8 | 5 | 0 | 0 | 0 | 8 |  |
...
| ➕ beyond_matrix | `leisure_sport_hobbies_vocab` 여가·운동·취미 어휘 | 49 |
...
| ✅ covered | `free_time_hobbies_sport` 여가·취미·운동 | 취미·운동·휴가·주말 계획 | 16 | 4 | 7 | 0 | 20 | 16 | model_knowledge |
...
| ✅ covered | `work_career` 직업·직장·취업 | 직장 첫걸음·근무표·학교생활 | 20 | 2 | 3 | 1 | 6 | 7 | model_knowledge |
...
| ✅ optional_covered | `weather_nature_climate` 날씨·계절·자연 | 날씨에 따른 계획 변경 | 29 | 3 | 2 | 0 | 2 | 17 | model_knowledge |
| ➕ beyond_matrix | `economy_business_labour` 경제·기업·노동시장 |  | 0 | 0 | 0 | 0 | 2 | 0 |  |
...
| ✅ covered | `leisure_sport_hobbies_vocab` 여가·운동·취미 어휘 | 16 |
...
| ➕ beyond_matrix | `professions_workplace` 직업·직장 어휘 | 20 |
| ➕ beyond_matrix | `school_study_terms` 학교·학습 어휘 | 34 |
| ➕ beyond_matrix | `time_calendar` 시간·날짜·요일·계절 | 11 |
| ➕ beyond_matrix | `weather_nature` 날씨·자연 어휘 | 29 |
