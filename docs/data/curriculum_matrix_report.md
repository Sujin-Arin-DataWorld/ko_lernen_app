...
- 갭 행 합계: **537** (`tool/curriculum_matrix_gaps.csv`)

| 레벨 | 주제(필수) ✅/🟡/❌ | 국제통용 문법 match/mismatch/missing | 브리프 하이라이트 ✅/🟡/❌ | 담화 특징 ✅/❌ | 기능(산출) ✅/🟡/❌ | 텍스트 유형 ✅/🟡/❌/⛔ | 어휘 영역 ✅/🟡/❌ | 문체 ✅/❌ | 시나리오 미연결 문법/전체 |
|---|---|---|---|---|---|---|---|---|---|
| A1 | 17/0/0 | 41/0/4 (of 45) | 24/2/1 | 2/0 | 11/4/0 | 4/0/1/5 | 12/1/1 | 2/1 | 31/55 |
...
### A1 문법 — 국제통용 45항목: match 41 · level_mismatch 0 · missing 4 (앱 A1 문법 55개)

**앱에 없는 국제통용 항목:** -겠-(선어말어미) · 이다(조사) · -지 않다(표현) · 이 아니다(표현)
...
**앱에 없는 국제통용 항목:** -다가1(1)(연결어미) · 에게로(조사) · 에다가(조사) · 에서부터(서부터)(조사) · -지(종결어미) · -을 것1(표현) · -지 말다(표현)
