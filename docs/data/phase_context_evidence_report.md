...
| KP09 | G3:-는구나 | 1 | 0 | 0 | 미검증 |
| KP09 | G3:-던- | 1 | 0 | 0 | 미검증 |
| KP09 | G3:-던데2 | 1 | 0 | 0 | 미검증 |
| KP09 | G3:아1 | 1 | 0 | 0 | 미검증 |
| KP09 | G3:요1 | 1 | 0 | 0 | 미검증 |
...
| KP19 | G5:-기에 앞서(서) | 1 | 0 | 1 | 미검증 |
| KP19 | G5:-는 가운데 | 1 | 0 | 0 | 미검증 |
| KP19 | G5:-는 동시에 | 1 | 0 | 1 | 미검증 |
...
| KP22 | G5:-기에 따라 | 1 | 0 | 1 | 미검증 |
| KP22 | G5:-은 나머지 | 2 | 0 | 0 | 미검증 |
...
- KP01 / G1:이다 / accepted / legacy_scenario_or_media: `assets/data/scenarios_a1.json/scenarios/0/dialog/5/ko` — “네, 한국이 처음이에요.”. 첫 방문 여부에 답하는 서술격 조사 활용이다. 처음이라는 상태를 확인하며 지명 자체를 이름으로 소개하는 문장은 아니다.
- KP01 / G1:은1 / accepted / legacy_scenario_or_media: `assets/data/scenarios_a1.json/scenarios/0/dialog/2/ko` — “한국은 처음이세요?”. 한국 방문을 화제로 삼아 처음인지 묻는다. 은의 화제 기능만 인정한다.
...
- KP01 / G1:-습니다 / accepted / legacy_scenario_or_media: `assets/data/scenarios_a1.json/scenarios/26/dialog/0/ko` — “다정식당입니다.”. 전화받은 직원이 격식체 -ㅂ니다로 가게를 밝힌다. 서술격 활용의 격식체 종결 용례다. 2026-09-15 재검수: 인접 대사 자연화(Jin 판정) 반영, 인용 구절·해당 대사 불변. 2026-09-22 재검수: 4f913017의 인접 고객 대사 수정(안녕하세요. 자리를 예약하고 싶어서 전화드렸어요.)을 실제 10개 대사와 대조했다. 전화받은 식당 직원과 예약 고객의 관계, 직원 첫 발화 및 -ㅂ니다 용례는 그대로다. 해당 수용 용례만 재확인하며 전체 시나리오의 급수·산출 평가·사람 검수를 승인하지 않는다.
...
- KP03 / G1:-고 싶다 / accepted / legacy_scenario_or_media: `assets/data/scenarios_a1.json/scenarios/25/dialog/1/ko` — “커트 예약하고 싶어요.”. 손님이 커트 예약 의사를 밝힌다. 이후 시각을 조율하므로 완료된 예약의 보고로 세지 않는다.
- KP03 / G1:-고 있다 / accepted / legacy_scenario_or_media: `assets/data/media_phrases.json/phrases/67/korean` — “한국어 공부하고 있어요”. 공부하고 있다는 진행 표현이 실제 원문에 있다. 짧은 단독 문구이므로 대화 수행이나 산출 평가까지 인정하지 않는다.
...
- KP07 / G2:-을게 / accepted / legacy_scenario_or_media: `assets/data/scenarios_a2.json/scenarios/3/dialog/5/ko` — “확인하고 다시 보낼게요.”. 첨부를 빠뜨린 발신자가 자신이 확인 후 재발송하겠다고 약속한다. 수신자에게 확인 책임을 넘기는 말이 아니다.
- KP07 / G2:-을래 / accepted / legacy_scenario_or_media: `assets/data/scenarios_a2.json/scenarios/14/dialog/0/ko` — “토요일에 이 전시 보러 갈래요?”. 상대의 참가 의향을 묻는 제안이며 다음 응답에서 토요일 불가가 나온다. 이미 만남이 확정됐다는 근거가 아니다.
- KP07 / G2:-는 것 같다 / accepted / legacy_scenario_or_media: `assets/data/scenarios_a2.json/scenarios/12/dialog/1/ko` — “제 택배가 여기 온 것 같아요.”. -은 것 같다의 과거 관형 변이로 배송 위치를 추정한다. 뒤에서 이름을 확인하므로 첫 발화의 추정과 최종 확인을 구별한다.
- KP07 / G1:-어서 / accepted / legacy_scenario_or_media: `assets/data/scenarios_a2.json/scenarios/7/dialog/1/ko` — “집에 일이 생겨서 오늘은 못 갈 것 같아.”. 집안 사정이 생긴 것을 불참의 이유로 설명한다. 말끝의 유보적 판단을 무시한 확정 완료로 읽지 않는다.
- KP07 / G2:-게2 / rejected / legacy_scenario_or_media: `assets/data/scenarios_a2.json/scenarios/7/dialog/3/ko` — “기다리게 해서 더 미안해.”. 기다리도록 목적을 정하는 용례가 아니라 상대를 기다리게 만든 사동적 결과에 대한 사과다. 동일한 게 문자열로 목적 요구를 채우지 않는다.
...
- KP09 / G3:-는다 / accepted / authored_phase_material: `tools/content_factory/cefr_matrix/phase_content/kp09.json/tasks/0/practice/sourceKo` — “나는 지금 옛 사진을 본다.”. 독백의 현재 행동 서술이다. 함께 보자는 청유나 미래 약속이 아니다. 신규로 작성한 Phase 자료의 수용 용례이며 기존 대화 재사용이나 산출 평가 완료 근거가 아니다.
- KP09 / G3:-니2 / accepted / authored_phase_material: `tools/content_factory/cefr_matrix/phase_content/kp09.json/tasks/1/practice/sourceKo` — “그때 어디에 살았니?”. 합의된 반말 관계에서 과거 거주지를 묻는 의문 종결이다. 이유 연결이 아니다. 신규로 작성한 Phase 자료의 수용 용례이며 기존 대화 재사용이나 산출 평가 완료 근거가 아니다.
- KP09 / G3:-자3 / accepted / authored_phase_material: `tools/content_factory/cefr_matrix/phase_content/kp09.json/tasks/2/practice/sourceKo` — “옛 사진을 같이 보자.”. 화자와 청자가 같이 할 행동을 제안하는 청유다. 시간 연결이나 청자만의 지시가 아니다. 신규로 작성한 Phase 자료의 수용 용례이며 기존 대화 재사용이나 산출 평가 완료 근거가 아니다.
- KP09 / G3:-는구나 / accepted / authored_phase_material: `tools/content_factory/cefr_matrix/phase_content/kp09.json/tasks/3/practice/sourceKo` — “많이 외로웠구나.”. 직전 화자가 혼자라서 외로웠다고 말한 감정을 새로 받아들이는 반응이다. 신규로 작성한 Phase 자료의 수용 용례이며 기존 대화 재사용이나 산출 평가 완료 근거가 아니다.
- KP09 / G3:-던- / accepted / authored_phase_material: `tools/content_factory/cefr_matrix/phase_content/kp09.json/tasks/4/practice/sourceKo` — “학생 때 매일 가던 카페를 다시 찾았다.”. 매일이라는 반복 과거 맥락이 던의 회상 관형 기능을 뒷받침한다. 신규로 작성한 Phase 자료의 수용 용례이며 기존 대화 재사용이나 산출 평가 완료 근거가 아니다.
- KP09 / G3:-던데2 / accepted / authored_phase_material: `tools/content_factory/cefr_matrix/phase_content/kp09.json/tasks/5/practice/sourceKo` — “그 식당 음식이 정말 맛있던데요!”. 앞문장에 어제 직접 가 봤다고 명시한 경험의 감탄·인상 회상이다. 신규로 작성한 Phase 자료의 수용 용례이며 기존 대화 재사용이나 산출 평가 완료 근거가 아니다.
- KP09 / G3:아1 / accepted / authored_phase_material: `tools/content_factory/cefr_matrix/phase_content/kp09.json/tasks/6/practice/sourceKo` — “지민아, 그 사진 기억나?”. 받침 있는 이름 지민 뒤에서 상대를 부르는 호격 아다. 감탄사 아가 아니다. 신규로 작성한 Phase 자료의 수용 용례이며 기존 대화 재사용이나 산출 평가 완료 근거가 아니다.
- KP09 / G3:요1 / accepted / authored_phase_material: `tools/content_factory/cefr_matrix/phase_content/kp09.json/tasks/7/practice/sourceKo` — “학생: 저요.”. 교사의 누가 먼저 말할래요에 자신을 가리키는 짧은 응답에 공손함을 더하는 조사 요다. 신규로 작성한 Phase 자료의 수용 용례이며 기존 대화 재사용이나 산출 평가 완료 근거가 아니다.
