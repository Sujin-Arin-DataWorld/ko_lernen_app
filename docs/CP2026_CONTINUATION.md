...
## 2026-09-23 19:57 UTC 현재 실행 기준선
...
| 현재 검증 main | #410 squash `1a5a629a6b81aa14f6cf8575bf1a43bb364f653f`. CI `35902073407` / Playwright `35902073366` 모두 success. #401–#404 수정도 포함 | 기기 검수와 내부 배포는 별도. #397의 추가 iOS native run `35855394802`도 성공했지만 시뮬레이터 증거임 |
| 다음 통합·배포 | 개인정보 동의 #409 head `a7d5cba6`의 앱 빌드·PW 성공. CI 에셋 잡은 fetch 20분 제한으로 취소돼 해당 잡만 attempt2 `107354766482`로 재시도 | 새 head 모든 검사·새 리뷰, 승인된 squash, 정확한 merged-main CI/PW 성공 후 양쪽 내부 배포 우선 |
| OCR 뜻 보완 | #405 main80 정상 통합 head61689d79의 CI/PW는 성공했으나 미해결 리뷰2건을 발견해 병합 보류. 로만은 누락과 오늘/내일/어제의 Adverb 분류로 인한 겹조사 뜻 누락10건을 재현 후 수정했고 새9파일177검사·전체분석 통과. 독립 검토가 찾은 부사 오인식4건도 재현해 보조사8묶음으로 제한했다. 겹조사는33개, 서술격13개는 기존 명사 제한 유지 | 추가 수정의 분석·두 축 검토·새 head 검사·리뷰 해결·병합·배포 게이트를 마친다. #406 지시문·#407 활용형/대안 표제어 저장은 별도 후속. 사람·실제 혼합 교재 촬영 검수 미완 |
| 준비된 후속 | 운영 알림 #411과 시작 속도 도구 #412의 PR CI/PW 성공, Word Web #413 등록·원격 검사 중. 증거가 다른 항목의 완료를 대신하지 않음 | 최신 main 정합·통합·실제 운영/기기 검증. Word Web 초안24개는 사람 및 퀴즈 승인 전 승격 차단 |
...
현재 증거는 `C:/dev/hangulsori/_codex_artifacts/cp2026-release-stabilization-20260922/`의 `android7653-publication-receipt.json`, `ios253-publication-receipt.json`, `pr410-main-success.json`, `privacy-main410/remote-retry-proof.json`, `next-internal-release-plan.json`, `ocr-main410/proof.json`, `content-coverage-main397.json`, `ga-streams-20260923-1931.txt`와 `jin-review/CHECKLIST.md`다. C01–C06 사람 검수, D01–D08 기기 검수와14일 품질 판정은 미완이다. 서로 다른 증거를 임의 가중해 전체 완료율을 만들지 않는다.
...
| O1 OCR 뜻 | #330/#352 병합. #405는 명사·부사 표제어의 겹조사33개·명사 서술격13개. 로/으로 대조와 시간 부사 뜻 누락을 추가 회귀로 보호하고 exact/서버 뜻 우선·출처를 보존 | #405 추가 리뷰 수정의 새head검사·통합·내부배포. #407 불규칙/대안표제어 저장, 광범위 동형어·사람/실제 혼합 교재 촬영 검수 미완 |
