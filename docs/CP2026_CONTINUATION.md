...
| OCR 뜻 보완 | #405 명사 겹조사32개·서술격13개. 이전 확장177/핵심116검사·분석·두 축 리뷰 통과, 실제 fixture23/23토큰. 현재 검증 main1a5a와 정상 병합하고 검토 코드·비중첩 변경 보존 | 이번 통합 회귀·분석·두 축 검토·새 head 검사·병합·배포는 아직 전. #406 지시문·#407 활용형은 별도 후속. 사람·실제 혼합 교재 촬영 검수 미완 |
