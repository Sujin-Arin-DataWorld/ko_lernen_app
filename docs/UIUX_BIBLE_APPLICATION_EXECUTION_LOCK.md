...
- **Version:** 1.15
- **Created:** 2026-08-21
- **Branch:** `session/uiux-bible-learning-3a-legacy-closeout-2026-08-21`
- **Base:** `origin/main@51409da37256cb1503474e0b1e03b720483360c3`
- **State:** Phase 3A Vocab/Deck outer UI merged; clean restart boundary
- **Next action:** create a fresh worktree from latest `origin/main` and audit
  `/grammar` outer study chrome/states only; preserve loaders, course context,
  answer/scoring logic, and activity geometry
...
| 3B–3D learning flows | pending | create a fresh worktree from latest `origin/main` and audit `/grammar` outer study chrome/states only; preserve loaders, course context, answer/scoring logic, and activity geometry |
