...
DE/EN missing, loading, partial-failure, retry-recovered, no-corpus, selection,
and populated states pass the locked 320x640 at 200%, 360x400, 390x844 at 130%,
720x1024 at 130%, and 1280x900 at 130% matrix using the app's `SoriTypeScale`.
All 13 destinations directly prove exact pack id, selected row order,
items/deck/phrases, loaders, `ignoreLevelLock`, and word-web seen set. Ten
focused tests, 864 related/shared tests, and the full local 4,461 tests with 14
...
three P2 fixes; its sole stale-lock finding is resolved by this v1.67 document.
