...
- **Next action:** push the current clean branch head containing app commit
  ...
  PR exact-head CI, and merge only when green
...
1. Push the current clean branch head containing locally verified app commit
   `aa096a2b17d834c1d3d4f74d33fec4871aa72b3b`, open a single PR, and rely on the
   automatic PR exact-head required CI without a duplicate manual dispatch.
