#!/usr/bin/env python3
"""Emit review-only Batch 14 scenario drafts: A2·B1·B2 기능 확장 7칸.
...
DRAFT_PATH = Path("tools/content_factory/drafts/c1_batch14_scenarios_a2_b2.json")
MANIFEST_PATH = Path("tools/content_factory/drafts/batch_14_manifest.json")
REVIEW_PATH = Path("tools/content_factory/review/c1_batch14_scenarios.csv")
...
CATEGORY_ORDER = ("enrolment", "booking", "insurance", "incident", "cancellation", "hiring", "privacy")
...
def build(root: Path = ROOT) -> dict[str, int]:
    ...
    draft = {
        "version": 1,
        "_comment": "Review-only Batch 14 scenarios. A2-B2 expansion shelves, four per shelf.",
        "scenarios": records,
    }
    manifest = {
        "version": 1,
        ...
        "provenance": {
            "scope": "Original A1 episodes for the A2-B2 expansion shelves.",
            "rights": "original",
