...
def build_manifest() -> dict[str, Any]:
    ...
    return {
        ...
        "statusReason": (
            "All 504 Batch 05 objects were synthesized and uploaded. The integrated "
            "Storage verification returned expected 6321, remote 6376, missing 0, "
            "and stale 55."
        ),
        ...
        "storageVerification": {
            ...
            "verifiedBy": "Jin",
            "environment": "authenticated Windows PowerShell and gcloud session",
            "command": "python tool/generate_tts.py --verify-storage",
            "expectedObjects": 6321,
            "remoteObjects": 6376,
            "missingObjects": 0,
            "staleObjects": 55,
            "stalePolicy": "retain immutable historical cache objects",
        },
        "counts": {
            "vocabHeadwords": 144,
            "vocabExamples": 144,
