...
PACKS: list[dict[str, Any]] = [
    _pack(
        ...
        [
            ("인사드리겠습니다", "ich werde mich höflich vorstellen", "I will greet you respectfully", "Ausdruck", "문 앞에서 인사드리겠습니다 하고 숨을 골랐어요.", "Vor der Tür sagte ich ich werde mich höflich vorstellen und holte Luft.", "At the door I said I will greet you respectfully and took a breath."),
            ...
            ("호칭", "Anrede", "form of address", "Nomen", "호칭이 어려워서 현우에게 물어봤어요.", "Die Anrede ist schwer, deshalb habe ich Hyunwoo gefragt.", "The form of address is hard, so I asked Hyunwoo."),
            ("높임말", "Höflichkeitsform", "raised speech", "Nomen", "부모님 앞에서는 높임말을 써요.", "Vor den Eltern benutze ich die Höflichkeitsform.", "I use raised speech in front of the parents."),
            ("성함을 묻다", "nach dem Namen fragen", "to ask someone's name politely", "Ausdruck", "성함을 묻기 전에 현우가 눈짓을 했어요.", "Bevor ich nach dem Namen fragte, gab Hyunwoo ein Zeichen.", "Before I asked the name politely, Hyunwoo gave a look."),
    ...
    _pack(
        ...
        [
            ...
            ("과한 선물", "zu großes Geschenk", "overly big gift", "Ausdruck", "과한 선물은 부담이 된다고 현우가 말했어요.", "Hyunwoo sagte, ein zu großes Geschenk mache Druck.", "Hyunwoo said an overly big gift creates pressure."),
            ...
            ("빈손", "mit leeren Händen", "empty-handed", "Nomen", "빈손으로 가면 현우가 더 긴장해요.", "Wenn ich mit leeren Händen komme, ist Hyunwoo noch nervöser.", "If I arrive empty-handed, Hyunwoo gets even more nervous."),
    ...
    _pack(
        ...
        [
            ...
            ("손님 슬리퍼", "Gästeslipper", "guest slippers", "Nomen", "손님 슬리퍼가 왼쪽 짝만 남았어요.", "Von den Gästeslippern war nur der linke übrig.", "Only the left guest slipper was left."),
            ...
            ("윗목", "der innere Sitzplatz", "inner seat of the room", "Nomen", "윗목은 어른 자리라서 현우가 눈을 깜빡였어요.", "Der innere Sitzplatz ist für Ältere, deshalb blinzelte Hyunwoo.", "The inner seat is for elders, so Hyunwoo blinked at me."),
            ...
            ("화장실 문", "Toilettentür", "bathroom door", "Nomen", "화장실 문을 열고 손님 슬리퍼를 또 찾았어요.", "Ich öffnete die Toilettentür und suchte wieder nach Gästeslippern.", "I opened the bathroom door and looked for guest slippers again."),
            ...
            ("집들이 예절", "Besuchsmanieren", "house-visit manners", "Ausdruck", "집들이 예절은 현우가 차에 타기 전에 알려 줬어요.", "Die Besuchsmanieren erklärte Hyunwoo noch vor der Autofahrt.", "Hyunwoo explained house-visit manners before we got in the car."),
        ],
    ),
    _pack(
        "partner_table_basic",
        ...
        [
            ...
            ("밑반찬", "Grundbeilagen", "basic side dishes", "Nomen", "밑반찬이 열 가지라서 눈이 커졌어요.", "Es gab zehn Grundbeilagen, da wurden meine Augen groß.", "There were ten basic side dishes, so my eyes got wide."),
            ...
            ("맛있어요", "es schmeckt", "it is delicious", "Ausdruck", "맛있어요를 매 접시마다 말하니 현우가 웃었어요.", "Bei jedem Teller sagte ich, dass es schmeckt, und Hyunwoo hat gelacht.", "I kept saying it was tasty, and Hyunwoo laughed."),
    ...
    _pack(
        ...
        [
            ...
            ("세배", "Neujahrsverbeugung", "New Year bow", "Nomen", "세배 각도를 현우가 거실에서 연습시켜 줬어요.", "Hyunwoo hat den Winkel der Neujahrsverbeugung im Wohnzimmer geübt.", "Hyunwoo had me practice the New Year bow in the living room."),
            ...
            ("한복", "Hanbok", "hanbok", "Nomen", "한복 고름을 앞에서 매다가 현우 엄마가 도와주셨어요.", "Als ich die Hanbok-Schleife vorne band, half Hyunwoos Mutter.", "Hyunwoo's mom helped when I tied the hanbok ribbon in front."),
    ...
    _pack(
        ...
        [
            ...
            ("시동생", "Schwager, jüngerer Bruder des Mannes", "husband's younger brother", "Nomen", "시동생이 게임을 하자고 해서 현우가 말렸어요.", "Der jüngere Schwager wollte spielen, aber Hyunwoo hielt ihn zurück.", "The younger brother wanted to play a game, but Hyunwoo stopped him."),
    ...
    _pack(
        ...
        "Photos and thanks",
        [
            ("인증샷", "Beweis-Foto", "proof photo", "Nomen", "인증샷은 올리지 말라고 현우가 먼저 말했어요.", "Hyunwoo sagte zuerst, das Beweis-Foto nicht hochzuladen.", "Hyunwoo said first not to post the proof photo."),
            ("가족 앨범", "Familienalbum", "family album", "Nomen", "가족 앨범에서 현우 교복 사진을 봤어요.", "Im Familienalbum sah ich Hyunwoos Schuluniform.", "I saw Hyunwoo's school uniform in the family album."),
            ...
            ("사진 전송", "Fotos senden", "sending photos", "Nomen", "사진 전송 전에 현우에게 먼저 보여 줬어요.", "Vor dem Senden zeigte ich die Fotos zuerst Hyunwoo.", "Before sending I showed the photos to Hyunwoo first."),
