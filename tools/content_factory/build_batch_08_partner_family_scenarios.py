...
GRAMMAR_BLOCK = {
    "a1": {
        "title": {
            "ko": "V-아/어 주세요",
            "de": "V-아/어 주세요: höflich bitten",
            "en": "V-아/어 주세요: asking politely",
        },
        "explanation": {
            "ko": "가족에게 도움을 강하게 요구하지 않고 정중히 부탁할 때 쓴다.",
            "de": "Eine höfliche Bitte ohne Druck, besonders vor der Familie.",
    ...
    "a2": {
        ...
        "explanation": {
            ...
            "de": "Markiert eine Hilfe oder einen Gefallen für die andere Person.",
    ...
    "c1": {
        "title": {
            "ko": "N을/를 고려하여",
            "de": "N을/를 고려하여: unter Berücksichtigung",
    ...
    "c2": {
        "title": {
            "ko": "N와/과 상관없이",
            "de": "N와/과 상관없이: unabhängig von",
            "en": "N와/과 상관없이: regardless of",
        },
        "explanation": {
            "ko": "혈연이나 체면과 무관하게 절차나 권리를 말할 때 쓴다.",
            "de": "Ein Recht oder Verfahren unabhängig von Verwandtschaft oder Gesicht nennen.",
...
SEEDS: list[dict[str, Any]] = [
    {
        ...
        "level": "a1",
        "backdrop": "home",
        "title": ("첫 현관 인사", "Erster Gruss an der Tür", "First greeting at the door"),
        "intro": (
            "현우 집에 처음 갑니다. 신발을 벗고 짧게 인사하세요.",
            "Du kommst zum ersten Mal zu Hyunwoo. Zieh die Schuhe aus und begrüße kurz.",
            "You visit Hyunwoo's home for the first time. Take off your shoes and greet briefly.",
        ),
        ...
        "dialog": [
            ("user", "안녕하세요. 처음 뵙겠습니다. 현우의 친구입니다.", "Guten Tag. Sehr erfreut. Ich bin Hyunwoos Freundin.", "Hello. Nice to meet you. I am Hyunwoo's friend."),
    ...
    },
    {
        ...
        "hearing_ok": ("Die Hüfte soll tiefer gebeugt werden.", "The waist should bend lower."),
        "dialog": [
            ("user", "새해 복 많이 받으세요.", "Ein gesegnetes neues Jahr.", "Happy new year."),
            ("npc", "허리를 더 숙이세요. 그다음 일어나요.", "Beugen Sie die Hüfte tiefer. Dann stehen Sie auf.", "Bend lower. Then stand up."),
            ("user", "제가 한 박자 늦었어요.", "Ich war einen Schlag zu spät.", "I was one beat late."),
            ...
            ("npc", "세뱃돈은 두 손으로 받으세요.", "Nehmen Sie das Geld mit beiden Händen.", "Take the money with both hands."),
            ("user", "제가 받아도 돼요?", "Darf ich es annehmen?", "May I accept it?"),
            ("npc", "오늘은 받으세요. 다음에 나눠 줘요.", "Heute nehmen Sie es. Später teilen Sie.", "Accept it today. Share later."),
        ],
    },
]
...
def more_seeds() -> list[dict[str, Any]]:
    ...
    catalog = [
        ("a1", "home", "songpyeon_too_big", "송편이 만두가 되다", "Songpyeon wird zur Teigtasche", "Songpyeon becomes a dumpling",
         ...
         "Die Songpyeon wurden zu groß. Lache und forme sie kleiner.",
         "The songpyeon grew too big. Laugh and shape them smaller.",
         ["손", "다시", "작다", "웃다", "도와주다", "지금"],
         "작게 다시 접으면 예뻐요.",
         ("Kleinere Faltung sieht schöner aus.", "A smaller fold looks nicer."),
         "손이 분홍해졌어요.", "Meine Finger wurden rosa.", "My fingers turned pink.",
         "작게 다시 접으면 예뻐요.", "Kleinere Faltung sieht schöner aus.", "A smaller fold looks nicer."),
        ...
        ("a2", "home", "leftover_bags", "싸 주시는 반찬", "Eingepackte Reste", "Packed leftovers",
         ...
         "국물이 안 새게 두 겹으로 했어요.", "Zwei Lagen, damit nichts ausläuft.", "Two layers so nothing leaks."),
        ...
        ("a2", "home", "banmal_slip", "반말 실수", "Ein Banmal-Fehler", "A casual-speech slip",
         ...
         "말실수했어요. 다시 존댓말로 할게요.", "Ich habe mich versprochen. Ich spreche wieder höflich.", "I slipped. I will use honorifics again.",
        ...
        ("b1", "home", "marriage_question", "결혼 계획 질문", "Die Heiratsfrage", "The marriage-plan question",
         ...
         "Die Großmutter fragt nach Heiratsplänen. Sei ehrlich und halte die Grenze.",
        ...
        ("b1", "restaurant", "drink_table", "술상 잔 받기", "Das Glas am Tisch", "Receiving a glass at the table",
         ...
         "Der Onkel bietet ein Glas an. Nimm es mit beiden Händen und bitte um Wasser.",
         "Uncle offers a glass. Take it with both hands and ask for water.",
         ["손", "물", "천천히", "감사", "지금", "괜찮다"],
         "물은 옆에 있어요.",
         ("Wasser steht daneben.", "Water is beside you."),
         "두 손으로 받을게요. 물은 있어도 될까요?", "Ich nehme es mit beiden Händen. Darf ich Wasser haben?", "I will take it with both hands. May I have water?",
         "물은 옆에 있어요.", "Das Wasser steht neben Ihnen.", "The water is beside you."),
        ("b1", "home", "overnight_door", "문 열어 두기", "Die Tür offen lassen", "Leaving the door open",
         "하룻밤을 묵는데 문을 열어 두라고 합니다. 경계를 정중히 말하세요.",
         "Über Nacht soll die Tür offen bleiben. Setze die Grenze höflich.",
         ...
         "문은 조금 열어 둘게요. 잠은 따로 잘게요.", "Ich lasse die Tür einen Spalt offen. Schlafen tun wir getrennt.", "I will leave the door a little open. We will sleep separately.",
         "아침에는 같이 밥 먹어요.", "Morgen früh esst ihr zusammen.", "In the morning you eat together."),
        ("b2", "home", "inlaw_rotation", "양쪽 집 명절", "Beide Elternhäuser", "Both family homes",
         "설날과 추석을 양쪽 집으로 나눠야 합니다. 순환안을 제안하세요.",
         "Seollal und Chuseok müssen auf beide Häuser verteilt werden. Schlage eine Rotation vor.",
         "Seollal and Chuseok must be split across both homes. Propose a rotation.",
         ["일정", "올해", "다음", "가족", "시간", "약속"],
         "올해는 이쪽, 다음엔 저쪽으로 하죠.",
         ("Dieses Jahr hier, das nächste Mal dort.", "This year here, next time there."),
         "올해는 현우 쪽, 다음 명절은 저희 쪽으로 하면 어때요?", "Dieses Jahr zu Hyunwoo, das nächste Fest zu uns, ja?", "How about Hyunwoo's side this year and ours next holiday?",
         "올해는 이쪽, 다음엔 저쪽으로 하죠.", "Dieses Jahr hier, danach dort.", "This year here, then there."),
        ("b2", "cafe", "public_intro", "밖에서 호칭", "Anrede in der Öffentlichkeit", "Address terms in public",
         ...
         "이쪽은 현우 어머니세요.", "Das ist Hyunwoos Mutter.", "This is Hyunwoo's mother.",
        ...
        ("c1", "home", "invisible_labor", "보이지 않는 일", "Unsichtbare Arbeit", "Invisible work",
         ...
         ["일", "나누다", "휴식", "제안", "함께", "다음"],
         "표로 나누면 감정도 편해져요.",
         ("Eine Tabelle entlastet auch die Gefühle.", "A chart eases feelings too."),
         "노동을 보이게 하고 교대로 쉬면 좋겠어요.", "Wenn die Arbeit sichtbar wird und Pausen wechseln, wäre es besser.", "If the work is visible and rest rotates, it would be better.",
        ...
        ("c2", "office", "name_and_memory", "이름과 기억", "Name und Erinnerung", "Name and memory",
         ...
         "In der Familienerzählung bleibt nur der Spitzname. Fordere den Namen und geteilte Erinnerung.",
         ...
         "별명 대신 이름을 쓰고 서사를 공유했으면 합니다.", "Statt des Spitznamens den Namen und eine geteilte Erzählung.", "I want the name instead of the nickname, and a shared story.",
        ...
        extras.append(
            {
                ...
                "dialog": [
                    ("user", u1, d1, e1),
                    ("npc", n1, nd1, ne1),
                    ("user", "제가 다시 확인해도 될까요?", "Darf ich das noch einmal prüfen?", "May I check that again?"),
                    ("npc", "네. 천천히 해도 돼요.", "Ja. Langsam ist in Ordnung.", "Yes. Slow is fine."),
                    ("user", "현우에게 한 번만 물어볼게요.", "Ich frage Hyunwoo nur einmal.", "I will ask Hyunwoo just once."),
                    ("npc", "그다음에 이어서 해요.", "Danach macht ihr weiter.", "Then you continue."),
                    ("user", "도와주셔서 감사합니다.", "Danke für die Hilfe.", "Thank you for the help."),
...
def variant_seeds() -> list[dict[str, Any]]:
    ...
    rows = [
        ("a1", "home", "gift_too_big", "과한 선물", "Zu großes Geschenk", "An overly big gift",
         "선물이 커서 현우가 긴장합니다. 작은 정성이라고 말하세요.",
         "Das Geschenk ist zu groß. Sag, es ist nur eine kleine Aufmerksamkeit.",
        ...
        ("a1", "home", "wrong_seat", "윗목 실수", "Der innere Sitzplatz", "The inner seat mistake",
         "윗목에 앉으려다 현우가 눈을 깜빡입니다. 아랫목으로 옮기세요.",
         "Du willst innen sitzen, Hyunwoo blinzelt. Wechsle nach vorne zur Tür.",
         "You almost sit in the inner seat. Move nearer the door.",
         ["앉다", "자리", "문", "물", "지금", "미안하다"],
         "아랫목이 더 편해요.",
         ("Der Platz an der Tür ist besser.", "The seat by the door is better.")),
        ("a1", "home", "new_year_money", "세뱃돈 받기", "Neujahrsgeld annehmen", "Accepting New Year money",
         ...
         ["손", "받다", "감사", "오늘", "가족", "돈"],
         "두 손으로 받으세요.",
         ("Nehmen Sie es mit beiden Händen.", "Take it with both hands.")),
        ("a2", "home", "morning_greeting", "아침 인사 큰 소리", "Der laute Morgengruß", "The loud morning greeting",
         "하룻밤을 잔 뒤 아침 인사를 해야 합니다. 큰 소리로 먼저 말하세요.",
         "Nach der Nacht musst du den Morgengruß sagen. Sprich zuerst laut.",
        ...
        ("a2", "home", "group_chat_join", "가족 단톡 입장", "Beitritt in den Familienchat", "Joining the family chat",
         ...
         "Du trittst in den Familienchat ein. Grüße kurz höflich mit einem Sticker.",
        ...
        ("a2", "market", "hanbok_rental", "한복 대여 마감", "Hanbok-Verleih zu früh zu", "Hanbok rental closed early",
         "명절 전날 한복 가게가 일찍 닫습니다. 단정한 옷으로 바꾸세요.",
         "Am Vortag schließt der Verleih früh. Wechsle zu schlichter Kleidung.",
        ...
        ("b1", "home", "salary_deflect", "월급 이야기 넘기기", "Das Gehalt ablenken", "Deflecting salary talk",
         ...
         "Man fragt nach dem Gehalt. Lächle und sag, du lernst noch.",
        ...
        ("b2", "home", "holiday_labor_chart", "설거지 교대 제안", "Abwaschwechsel vorschlagen", "Proposing a dish rotation",
         ...
         "Der Abwasch lastet auf einer Seite. Schlage lächelnd einen Wechsel vor.",
         "Dishwashing sits on one side. Smile and propose a rotation.",
         ["돕다", "같이", "다음", "일", "웃다", "제안"],
         "이번에는 제가 할게요.",
         ("Diesmal mache ich es.", "This time I will do it.")),
        ("b2", "cafe", "photo_permission", "사진 공개 확인", "Fotoeröffentlichung prüfen", "Checking before posting a photo",
         "단체 사진을 올리기 전에 얼굴을 확인해야 합니다. 동의를 받으세요.",
         "Vor dem Hochladen musst du die Gesichter prüfen. Hol das Einverständnis.",
        ...
        extras.append(
            {
                ...
                "dialog": [
                    ...
                    ("npc", hko, hok[0], hok[1]),
                    ("user", "현우에게 한 번 확인하고 이어갈게요.", "Ich prüfe einmal bei Hyunwoo und mache dann weiter.", "I will check once with Hyunwoo and then continue."),
                    ...
                    ("npc", "그러면 다음이 편해져요.", "Dann wird das Nächste leichter.", "Then the next time gets easier."),
                    ("user", "오늘 배려해 주셔서 감사합니다.", "Danke für die Rücksicht heute.", "Thank you for the consideration today."),
                    ("npc", "다음에 또 이야기해요.", "Sprechen wir das nächste Mal weiter.", "Let us talk again next time."),
                ],
            }
        )
    return extras
...
A1_REPAIR_QUESTS: dict[str, dict[str, Any]] = {
    ...
    "a1_partner_gift_too_big": {
        ...
        "satz": {
            ...
            "promptDe": "Danke für die Rücksicht heute.",
