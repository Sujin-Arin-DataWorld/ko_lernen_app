...
ADVANCED_SMALLTALK = [
    ...
    talk("c2", "food", "‘합리적 가격’은 누구의 소득과 시간 비용을 전제로 하나요?", "Wessen Einkommen und Zeitkosten setzt ein als angemessen bezeichneter Preis voraus?", "Whose income and time costs does a price described as reasonable assume?", "소비자 가격만 보면 배달 노동과 조리 노동이 지워질 수 있어요.", "Ein Blick nur auf Verbraucherpreise kann Liefer- und Küchenarbeit unsichtbar machen.", "Looking only at consumer prices can erase delivery and kitchen labor."),
