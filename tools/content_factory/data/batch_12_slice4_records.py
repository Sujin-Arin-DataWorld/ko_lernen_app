...
VOCAB_C2: list[dict[str, Any]] = [
    ...
    {
        "korean": "호명", "rom": "homyeong", "de": "namentliche Benennung", "en": "calling out by name",
        "ex_ko": "특정인을 향한 호명이 시작되면 대화가 멈춥니다.",
        "ex_de": "Beginnt die namentliche Benennung einer bestimmten Person, endet das Gespräch.",
        "ex_en": "Once calling out a specific person by name starts, the conversation stops.",
