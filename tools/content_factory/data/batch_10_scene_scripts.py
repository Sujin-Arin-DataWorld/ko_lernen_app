...
FRAME_POOLS: dict[tuple[str, bool], dict[str, tuple[tuple[str, str, str], ...]]] = {
    ...
    ("coworker", True): {
        ...
        "check_do": (
            ...
            ("네, 제가 그렇게 맞춰 두겠습니다.", "Ja, ich passe es entsprechend an.", "Yes, I'll adjust it that way."),
            ("알겠습니다. 바로 정리하겠습니다.", "Gut. Ich sortiere es gleich.", "Sure. I'll sort it right away."),
            ("네, 그렇게 하겠습니다.", "Ja, mache ich.", "Yes, I'll do that."),
        ),
        "check_ok": (
            ("알겠습니다. 그렇게 하죠.", "Gut. Machen wir so.", "Sure. Let's do that."),
            ("네, 좋습니다.", "Ja, in Ordnung.", "Yes, that works."),
            ("알겠어요. 그럼 그 방향으로 가죠.", "Gut. Dann in diese Richtung.", "Okay. Let's go that way then."),
...
_add(
    ...
    need=("길게 쓰지 말고 한 일만 세 줄로 남기고 싶어요.", "Nicht lang. Nur drei Zeilen zu dem, was erledigt ist.", "Keep it short. I just want three lines of what was done."),
