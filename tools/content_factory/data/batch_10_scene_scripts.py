...
_add(
    ...
    ask=("무게를 먼저 재 볼까요?", "Soll ich zuerst das Gewicht messen?", "Shall I weigh it first?"),
...
_add(
    ...
    need=("십 분 늦을게. 먼저 먹어.", "Ich bin zehn Minuten später. Iss schon mal.", "I will be ten minutes late. Start eating."),
    ask=("문자를 엄마에게 보냈어?", "Hast du Mama schon geschrieben?", "Did you text mom?"),
    wait=("곧 도착한다고 다시 쓸게.", "Ich schreibe gleich, dass ich bald da bin.", "I will write again that I am almost there."),
...
_add(
    ...
    ask=("이름을 문에 적어 둘까요?", "Soll ich den Namen an die Tür schreiben?", "Shall I write the name on the door?"),
...
_add(
    ...
    ask=("이 신발을 안으로 옮길까요?", "Soll ich diese Schuhe nach drinnen bringen?", "Shall I move these shoes inside?"),
...
_add(
    ...
    ask=("연필을 같이 드릴까요?", "Soll ich einen Bleistift dazu geben?", "Shall I give you a pencil too?"),
...
_add(
    ...
    wait=("지금 바로 걷겠습니다.", "Ich sammle gleich ein.", "I will collect them now."),
...
_add(
    ...
    need=("오늘 춥대. 겉옷 가져갈게.", "Heute soll es kalt sein. Ich nehme eine Jacke mit.", "It is supposed to be cold today. I will take a jacket."),
...
_add(
    ...
    ask=("이 흰색을 드릴까요?", "Soll ich diese weiße geben?", "Shall I give you this white one?"),
    wait=("계산대에서 바로 드릴게요.", "An der Kasse gebe ich sie gleich.", "I will give it to you at the register now."),
...
_add(
    ...
    ask=("음료를 먼저 시켜 둘까?", "Soll ich schon ein Getränk bestellen?", "Shall I order a drink first?"),
...
_add(
    ...
    ask=("이 문장을 다시 들을까요?", "Soll ich diesen Satz noch einmal sagen?", "Shall I say this sentence again?"),
    wait=("천천히 다시 말하겠습니다.", "Ich sage es gleich langsamer.", "I will say it more slowly now."),
...
_add(
    ...
    need=("나 왔어. 문 좀 열어 줘.", "Ich bin da. Mach bitte die Tür auf.", "I am here. Please open the door."),
    ask=("열쇠를 가져왔어?", "Hast du den Schlüssel dabei?", "Did you bring the key?"),
    wait=("지금 내려갈게. 일 분만 기다려.", "Ich komme runter. Warte eine Minute.", "I will come down. Wait one minute."),
...
_add(
    ...
    wait=("발음은 바로 다시 해 드릴게요.", "Die Aussprache mache ich gleich noch einmal.", "I will say the pronunciation again now."),
...
_add(
    ...
    need=("실례합니다. 지나갈게요.", "Entschuldigung. Ich gehe vorbei.", "Excuse me. I will pass through."),
...
_add(
    ...
    wait=("처음부터 다시 말할게요.", "Ich sage es gleich von vorn.", "I will say it from the start."),
...
_add(
    ...
    need=("나 역 앞이야. 곧 와?", "Ich bin vor dem Bahnhof. Kommst du gleich?", "I am in front of the station. Are you coming soon?"),
    ask=("빨간 문을 보고 있으면 돼?", "Soll ich zur roten Tür schauen?", "Should I watch the red door?"),
    wait=("오 분 안에 나갈게.", "Ich komme in fünf Minuten raus.", "I will come out in five minutes."),
...
_add(
    ...
    need=("오늘 산책 취소하자. 너무 피곤해.", "Sagen wir den Spaziergang heute ab. Ich bin zu müde.", "Let's cancel the walk today. I am too tired."),
    ask=("차를 집에 끓일까?", "Soll ich zu Hause Tee kochen?", "Shall I make tea at home?"),
...
_add(
    ...
    ask=("이 길을 따라갈까요?", "Soll ich dieser Straße folgen?", "Shall I follow this road?"),
...
_add(
    ...
    wait=("열쇠는 바로 드리겠습니다.", "Den Schlüssel gebe ich gleich.", "I will give you the key now."),
...
_add(
    ...
    need=("카트 하나 어디에 있어요?", "Wo gibt es einen Wagen?", "Where can I get a cart?"),
...
_add(
    ...
    ask=("김밥을 반으로 잘라 드릴까요?", "Soll ich das Kimbap halbieren?", "Shall I cut the kimbap in half?"),
...
_add(
    ...
    ask=("이 버튼을 눌러 볼까요?", "Soll ich diesen Knopf drücken?", "Shall I press this button?"),
...
_add(
    ...
    wait=("번호를 바로 불러 드릴게요.", "Ich sage Ihnen die Nummer gleich.", "I will read the number now."),
...
_add(
    ...
    ask=("스위치를 왼쪽에서 찾을까?", "Soll ich den Schalter links suchen?", "Shall I look for the switch on the left?"),
...
_add(
    ...
    ask=("기간을 열흘로 넣을까요?", "Soll ich zehn Tage eintragen?", "Shall I set it for ten days?"),
...
_add(
    ...
    need=("락커 하나 맡기고 운동할게요.", "Ich gebe einen Spind ab und trainiere dann.", "I will leave a locker and then work out."),
    ask=("자물쇠를 앞에서 빌릴까요?", "Soll ich das Schloss vorn ausleihen?", "Shall I borrow a lock at the front?"),
    wait=("락커는 바로 안내하겠습니다.", "Den Spind zeige ich gleich.", "I will show you the locker now."),
...
_add(
    ...
    ask=("이 갈색을 쓸까요?", "Soll ich dieses Braun nehmen?", "Shall I use this brown?"),
...
_add(
    ...
    ask=("근무 시간을 다시 적어 볼까요?", "Soll ich die Arbeitszeit noch einmal notieren?", "Shall I write the hours again?"),
...
_add(
    ...
    wait=("보관함을 바로 찾아보겠습니다.", "Ich schaue gleich im Fundfach nach.", "I will check the hold box now."),
...
_add(
    ...
    ask=("색깔을 종이에 적을까요?", "Soll ich die Farbe auf Papier schreiben?", "Shall I write the color on paper?"),
...
_add(
    ...
    wait=("스탬프는 바로 찍어 드립니다.", "Den Stempel setze ich gleich.", "I will stamp it now."),
...
_add(
    ...
    ask=("이십오 일로 바꿀까요?", "Soll ich auf den Fünfundzwanzigsten ändern?", "Shall I change it to the twenty-fifth?"),
...
_add(
    ...
    wait=("예약은 바로 옮겨 드립니다.", "Ich verschiebe den Termin gleich.", "I will move the booking now."),
...
_add(
    ...
    wait=("오늘 밤부터 조심하겠습니다.", "Ab heute Nacht passe ich auf.", "I will be careful from tonight."),
...
_add(
    ...
    ask=("이 메모를 책상 위에 둘까요?", "Soll ich diese Notiz auf den Tisch legen?", "Shall I put this note on the desk?"),
    wait=("아침에 바로 볼 수 있게 두겠습니다.", "Ich lege sie so, dass man sie morgens gleich sieht.", "I will leave it so it is seen in the morning."),
...
_add(
    ...
    wait=("신분증은 바로 드리겠습니다.", "Den Ausweis gebe ich gleich.", "I will give you the ID now."),
...
_add(
    ...
    ask=("따뜻한 잔을 드릴까요?", "Soll ich eine warme Tasse geben?", "Shall I give you a warm cup?"),
...
_add(
    ...
    wait=("오후에 바로 비우겠습니다.", "Nachmittags räume ich gleich leer.", "I will empty it in the afternoon."),
...
_add(
    ...
    ask=("이름을 여기에 적을까요?", "Soll ich den Namen hier eintragen?", "Shall I write the name here?"),
...
_add(
    ...
    frame="coworker",
    rel="coworker",
    sit=("점장에게 하루 휴가를 요청합니다.", "Man bittet die Leitung um einen Urlaubstag.", "You ask the manager for a day of leave."),
    ...
    ask=("대체 근무를 누가 할지 적을까요?", "Soll ich eintragen, wer übernimmt?", "Shall I write who will cover?"),
    wait=("오후에 바로 답 드리겠습니다.", "Nachmittags antworte ich gleich.", "I will answer in the afternoon."),
...
_add(
    ...
    ask=("가방을 의자에 올려 둘까?", "Soll ich die Tasche auf den Stuhl legen?", "Shall I put the bag on the chair?"),
    wait=("오 분이면 돌아올게.", "In fünf Minuten bin ich zurück.", "I will be back in five minutes."),
...
_add(
    ...
    ask=("병을 이쪽에 둘까?", "Soll ich die Flasche hierhin stellen?", "Shall I put the bottle on this side?"),
...
_add(
    ...
    wait=("오 분만 기다리겠습니다.", "Ich warte fünf Minuten.", "I will wait five minutes."),
...
_add(
    ...
    wait=("차액은 바로 드리겠습니다.", "Die Differenz gebe ich gleich.", "I will give you the difference now."),
...
_add(
    ...
    wait=("계산서는 바로 나눠 드리겠습니다.", "Die Rechnung teile ich gleich auf.", "I will split the bill now."),
...
_add(
    ...
    need=("열한 시에 도착할 것 같아요. 그래도 들어가도 돼요?", "Ich komme wohl um dreiundzwanzig Uhr. Kann ich trotzdem rein?", "I will probably arrive at eleven. Can I still go in?"),
    ask=("문을 야간 벨로 열까요?", "Soll ich die Tür über die Nachtklingel öffnen?", "Shall I open the door with the night bell?"),
    wait=("도착하시면 바로 열어 드리겠습니다.", "Wenn Sie da sind, öffne ich gleich.", "When you arrive I will open right away."),
...
_add(
    ...
    wait=("가방은 바로 드리겠습니다.", "Die Tasche gebe ich gleich.", "I will give you the bag now."),
...
_add(
    ...
    wait=("오후에 바로 보내겠습니다.", "Nachmittags sende ich gleich.", "I will send it in the afternoon."),
...
_add(
    ...
    ask=("이 파일만 다시 붙일까요?", "Soll ich nur diese Datei noch einmal anhängen?", "Shall I attach only this file again?"),
    wait=("오 분 안에 다시 보내겠습니다.", "In fünf Minuten sende ich erneut.", "I will send it again in five minutes."),
...
_add(
    ...
    wait=("오늘 밤부터 바로 줄이겠습니다.", "Ab heute Nacht mache ich es gleich leiser.", "I will keep it down from tonight."),
...
_add(
    ...
    wait=("내일까지 계산해서 알려 줄게.", "Bis morgen rechne ich es aus.", "I will calculate it by tomorrow."),
...
_add(
    ...
    wait=("금액은 오늘 안에 적어 드리겠습니다.", "Den Betrag schreibe ich Ihnen heute noch auf.", "I will write the amount today."),
...
_add(
    ...
    wait=("명단은 오늘 저녁에 올리겠습니다.", "Die Liste stelle ich heute Abend ein.", "I will post the list this evening."),
...
_add(
    ...
    wait=("시간은 바로 넣어 드리겠습니다.", "Ich trage die Zeit gleich ein.", "I will put the time in now."),
...
_add(
    ...
    need=("천장 얼룩을 사진으로 찍어서 보낼게요.", "Ich fotografiere den Fleck an der Decke und sende ihn.", "I will photograph the ceiling stain and send it."),
    ask=("날짜가 보이게 찍을까요?", "Soll das Datum mit drauf?", "Shall I include the date in the photo?"),
    wait=("오후에 바로 전달하겠습니다.", "Nachmittags leite ich es gleich weiter.", "I will pass it on in the afternoon."),
...
_add(
    ...
    ask=("수요일 오전을 넣을까요?", "Soll ich Mittwochvormittag eintragen?", "Shall I put in Wednesday morning?"),
...
_add(
    ...
    wait=("금액은 오늘 안에 계산해 드리겠습니다.", "Den Betrag rechne ich Ihnen heute noch aus.", "I will calculate the amount today."),
...
_add(
    ...
    ask=("이 세 줄만 보낼까요?", "Soll ich nur diese drei Zeilen senden?", "Shall I send only these three lines?"),
    wait=("오후에 바로 넣겠습니다.", "Nachmittags setze ich sie gleich ab.", "I will send it in the afternoon."),
...
_add(
    ...
    need=("토요일에 손님이 두 명 와요. 미리 알려 드려요.", "Am Samstag kommen zwei Gäste. Ich sage es vorher.", "Two guests come on Saturday. I am telling you in advance."),
    ask=("주차 자리를 하나 비워 둘까요?", "Soll ich einen Parkplatz frei halten?", "Shall I keep one parking space free?"),
    wait=("저녁 전에 다시 연락할게요.", "Vor dem Abend melde ich mich noch einmal.", "I will contact you again before evening."),
...
_add(
    ...
    ask=("양쪽을 모두 스캔할까요?", "Soll ich beide Seiten scannen?", "Shall I scan both sides?"),
    wait=("파일은 오 분 안에 보내 드리겠습니다.", "Die Datei sende ich in fünf Minuten.", "I will send the file in five minutes."),
...
_add(
    ...
    ask=("위임 칸에 이름을 넣을까요?", "Soll ich den Namen ins Vertretungsfeld setzen?", "Shall I put the name in the proxy box?"),
...
_add(
    ...
    ask=("노란 큰 옷을 드릴까요?", "Soll ich die große Gelbe geben?", "Shall I give you the large yellow one?"),
    wait=("조끼는 바로 옆에 있습니다.", "Die Westen liegen gleich daneben.", "The vests are right next to us."),
...
_add(
    ...
    ask=("이 금액을 추가할까요?", "Soll ich diesen Betrag ergänzen?", "Shall I add this amount?"),
    wait=("새 견적은 내일 아침에 보내 드리겠습니다.", "Den neuen Voranschlag sende ich morgen früh.", "I will send the new quote tomorrow morning."),
...
_add(
    ...
    ask=("전화 번호를 여기에 적을까요?", "Soll ich die Telefonnummer hier eintragen?", "Shall I write the phone number here?"),
    wait=("빈자리가 나면 바로 연락드리겠습니다.", "Wenn ein Platz frei wird, melde ich mich gleich.", "If a seat opens I will contact you right away."),
...
_add(
    ...
    wait=("표는 오늘 저녁에 고치겠습니다.", "Den Plan ändere ich heute Abend.", "I will fix the table this evening."),
...
_add(
    ...
    wait=("기간은 오늘 안에 확인해 드리겠습니다.", "Die Frist prüfe ich Ihnen heute noch.", "I will confirm the period today."),
...
_add(
    ...
    need=("다음 편 탑승구가 바뀌었는지 봐 주세요.", "Bitte prüfen, ob sich das Gate des Anschlusses geändert hat.", "Please check if the next flight's gate has changed."),
...
_add(
    ...
    ask=("접수일을 한 번 더 확인할까요?", "Soll ich das Annahmedatum noch einmal prüfen?", "Shall I check the filing date once more?"),
...
_add(
    ...
    need=("오늘 육 시에 못 가서 육 시 반에 갈게요.", "Heute schaffe ich nicht um achtzehn Uhr, sondern um halb sieben.", "I cannot come at six today. I will come at six thirty."),
    ask=("교실에서 기다리게 할까요?", "Soll das Kind im Raum warten?", "Should the child wait in the classroom?"),
    wait=("도착하면 바로 전화할게요.", "Wenn ich da bin, rufe ich gleich an.", "When I arrive I will call right away."),
...
_add(
    ...
    ask=("월요일 같은 방을 드릴까요?", "Soll ich montags dasselbe Zimmer geben?", "Shall I give the same room on Monday?"),
...
_add(
    ...
    frame="service",
    rel="customer_and_service_staff",
    sit=("회사 정산을 위해 택시 영수증을 받습니다.", "Für die Abrechnung holt man den Taxibeleg.", "You get a taxi receipt for company reimbursement."),
    need=("회사 제출용 영수증 하나 주세요.", "Einen Beleg für die Firma, bitte.", "One receipt for the company, please."),
    ask=("카드 전표를 같이 드릴까요?", "Soll ich den Kartenbeleg dazu geben?", "Shall I include the card slip?"),
...
_add(
    ...
    wait=("같은 무게로 바로 바꿔 드리겠습니다.", "Ich tausche gleich gegen dasselbe Gewicht.", "I will exchange it for the same weight now."),
...
_add(
    ...
    ask=("이 철자를 그대로 넣을까요?", "Soll ich diese Schreibweise so übernehmen?", "Shall I put this spelling as is?"),
    wait=("영수증은 바로 다시 뽑아 드리겠습니다.", "Die Rechnung drucke ich gleich neu.", "I will print the receipt again now."),
...
_add(
    ...
    ask=("이 세 문장만 남길까요?", "Soll ich nur diese drei Sätze behalten?", "Shall I keep only these three sentences?"),
    wait=("오후에 바로 올려 두겠습니다.", "Nachmittags stelle ich sie gleich ein.", "I will post them in the afternoon."),
...
_add(
    ...
    wait=("기록은 오늘 안에 넣겠습니다.", "Den Eintrag setze ich heute noch.", "I will put the record in today."),
...
_add(
    ...
    ask=("이 봉투에 사본을 넣을까요?", "Soll ich eine Kopie in diesen Umschlag legen?", "Shall I put a copy in this envelope?"),
    wait=("접수증은 바로 드리겠습니다.", "Die Annahmebestätigung gebe ich gleich.", "I will give you the receipt now."),
...
_add(
    ...
    wait=("범위는 내일 문장으로 보내 드리겠습니다.", "Den Umfang sende ich morgen als Satz.", "I will send the scope as a sentence tomorrow."),
...
_add(
    ...
    need=("이 숫자가 원문 표와 같은지 확인해 주세요.", "Bitte prüfen, ob diese Zahl zur Quelltabelle passt.", "Please check whether this number matches the source table."),
...
_add(
    ...
    wait=("확인이 끝나면 바로 알려 드리겠습니다.", "Wenn die Prüfung fertig ist, sage ich gleich Bescheid.", "When the check is done I will tell you right away."),
...
_add(
    ...
    ask=("이 두 칸만 바꿀까요?", "Soll ich nur diese zwei Felder tauschen?", "Shall I swap only these two boxes?"),
    wait=("순서는 오전에 다시 올려 두겠습니다.", "Die Reihenfolge stelle ich vormittags neu ein.", "I will post the order again in the morning."),
...
_add(
    ...
    wait=("두 명이 오면 바로 시작하겠습니다.", "Wenn zwei Personen kommen, starte ich gleich.", "When two more people arrive I will start."),
...
_add(
    ...
    wait=("문장은 오늘 저녁에 보내 드리겠습니다.", "Den Satz sende ich heute Abend.", "I will send the sentence this evening."),
...
_add(
    ...
    ask=("타이머를 지금 켤까요?", "Soll ich den Timer jetzt starten?", "Shall I start the timer now?"),
    wait=("시간이 되면 바로 끊겠습니다.", "Wenn die Zeit um ist, breche ich gleich ab.", "When time is up I will stop."),
...
_add(
    ...
    wait=("한 장은 내일 아침에 올리겠습니다.", "Die eine Seite stelle ich morgen früh ein.", "I will post the one page tomorrow morning."),
...
_add(
    ...
    wait=("가정은 오늘 안에 넣어 두겠습니다.", "Die Annahme setze ich heute noch ein.", "I will put the assumption in today."),
...
_add(
    ...
    need=("금액이 제 권한을 넘어서 위로 올려야 해요.", "Der Betrag übersteigt meine Befugnis. Es muss nach oben.", "The amount is beyond my authority. It has to go up."),
    ask=("이 요약만 첨부할까요?", "Soll ich nur diese Kurzfassung anhängen?", "Shall I attach only this summary?"),
    wait=("전달은 오후에 바로 하겠습니다.", "Die Weitergabe mache ich nachmittags gleich.", "I will pass it on in the afternoon."),
...
_add(
    ...
    frame="coworker",
    rel="coworker",
    sit=("사건 번호 없이 진행하지 않기로 합니다.", "Ohne Fallnummer geht man nicht weiter.", "You do not continue without a case number."),
    ...
    ask=("임시 번호를 먼저 받을까요?", "Soll ich zuerst eine vorläufige Nummer holen?", "Shall I get a temporary number first?"),
...
_add(
    ...
    frame="coworker",
    rel="coworker",
    sit=("이 자료로 말할 수 있는 한계를 한 문장으로 적습니다.", "Man schreibt in einem Satz, was diese Unterlage nicht tragen kann.", "You write in one sentence what this material cannot support."),
    ...
    wait=("문장은 오늘 저녁에 넣겠습니다.", "Den Satz setze ich heute Abend ein.", "I will put the sentence in this evening."),
...
_add(
    ...
    ask=("이 눈금만 고칠까요?", "Soll ich nur diese Skala ändern?", "Shall I change only this scale?"),
    wait=("도표는 오전에 다시 올리겠습니다.", "Das Diagramm stelle ich vormittags neu ein.", "I will post the chart again in the morning."),
...
_add(
    ...
    ask=("이 네 줄만 남길까요?", "Soll ich nur diese vier Zeilen behalten?", "Shall I keep only these four lines?"),
    wait=("초안은 내일 아침에 돌리겠습니다.", "Den Entwurf schicke ich morgen früh herum.", "I will circulate the draft tomorrow morning."),
...
_add(
    ...
    need=("이 사진 날짜가 사고 당일이 맞는지 확인해 주세요.", "Bitte prüfen, ob das Fotodatum der Schadentag ist.", "Please check whether the photo date is the day of the incident."),
    ask=("파일 정보를 같이 열까요?", "Sollen wir die Dateiinfos zusammen öffnen?", "Shall we open the file info together?"),
    wait=("날짜는 한 시간 안에 적어 두겠습니다.", "Das Datum schreibe ich in einer Stunde auf.", "I will write the date in an hour."),
...
_add(
    ...
    ask=("이 주의 문장을 위에 넣을까요?", "Soll dieser Warnsatz nach oben?", "Shall this caution sentence go at the top?"),
    wait=("문장은 오늘 안에 넣겠습니다.", "Den Satz setze ich heute noch ein.", "I will put the sentence in today."),
...
_add(
    ...
    ask=("이 질문으로 올릴까요?", "Soll ich diese Frage einstellen?", "Shall I post this question?"),
...
_add(
    ...
    wait=("제안은 오늘 저녁에 보내겠습니다.", "Den Vorschlag sende ich heute Abend.", "I will send the offer this evening."),
...
_add(
    ...
    wait=("정의는 내일 오전에 적어 두겠습니다.", "Die Definition schreibe ich morgen früh auf.", "I will write the definition tomorrow morning."),
...
_add(
    ...
    wait=("방문 시간은 오늘 저녁에 잡겠습니다.", "Die Besuchszeit lege ich heute Abend fest.", "I will set the visit time this evening."),
...
_add(
    ...
    ask=("이 날짜를 기준으로 쓸까요?", "Soll ich dieses Datum als Basis nehmen?", "Shall I use this date as the base?"),
...
_add(
    ...
    ask=("읽음 확인을 켤까요?", "Soll ich die Lesebestätigung einschalten?", "Shall I turn on read receipt?"),
    wait=("발송은 오후에 바로 하겠습니다.", "Den Versand mache ich nachmittags gleich.", "I will send it in the afternoon."),
...
_add(
    ...
    ask=("이 두 번호를 바꿀까요?", "Soll ich diese zwei Nummern tauschen?", "Shall I swap these two numbers?"),
...
_add(
    ...
    wait=("설명은 오늘 안에 적어 드리겠습니다.", "Die Erklärung schreibe ich Ihnen heute noch auf.", "I will write the explanation today."),
...
_add(
    ...
    need=("미터기가 멈춘 채로 요금이 올랐어요. 위에 전해 주세요.", "Der Taxameter stand, der Preis stieg. Bitte nach oben geben.", "The meter was stopped but the fare rose. Please pass it up."),
    ask=("주행 경로를 같이 저장할까요?", "Soll ich die Fahrtroute mitspeichern?", "Shall I save the route as well?"),
...
_add(
    ...
    wait=("메모는 오후에 돌려 두겠습니다.", "Die Notiz gebe ich nachmittags weiter.", "I will pass the note in the afternoon."),
...
_add(
    ...
    wait=("순서는 자리에서 바로 적어 두겠습니다.", "Die Reihenfolge schreibe ich gleich am Platz auf.", "I will write the order at the table now."),
...
_add(
    ...
    ask=("보류 표시를 지금 넣을까요?", "Soll ich die Haltemarkierung jetzt setzen?", "Shall I put the hold mark now?"),
    wait=("파일이 오면 바로 다시 열겠습니다.", "Wenn die Datei da ist, öffne ich gleich wieder.", "When the file arrives I will open it again."),
...
_add(
    ...
    ask=("이 항목을 다시 출력할까요?", "Soll ich diesen Posten neu drucken?", "Shall I print this item again?"),
...
_add(
    ...
    ask=("이 문장을 주방에 전달할까요?", "Soll ich diesen Satz in die Küche geben?", "Shall I pass this sentence to the kitchen?"),
    wait=("메모는 바로 붙이겠습니다.", "Die Notiz hänge ich gleich an.", "I will put the note up now."),
...
_add(
    ...
    ask=("이 위험을 안내에 넣을까요?", "Soll ich dieses Risiko in den Hinweis?", "Shall I put this risk in the notice?"),
    wait=("안내는 오늘 저녁에 고치겠습니다.", "Den Hinweis ändere ich heute Abend.", "I will fix the notice this evening."),
...
_add(
    ...
    ask=("주소를 여기에 적을까요?", "Soll ich die Adresse hier eintragen?", "Shall I write the address here?"),
...
_add(
    ...
    wait=("숫자는 오전에 다시 맞춰 두겠습니다.", "Die Zahl gleiche ich vormittags noch einmal ab.", "I will match the number again in the morning."),
...
_add(
    ...
    wait=("슬라이드는 오전에 고치겠습니다.", "Die Folie ändere ich vormittags.", "I will fix the slide in the morning."),
...
_add(
    ...
    ask=("이 순서를 안내에 적을까요?", "Soll ich diese Reihenfolge in den Hinweis?", "Shall I write this order in the notice?"),
    wait=("안내는 오늘 저녁에 올리겠습니다.", "Den Hinweis stelle ich heute Abend ein.", "I will post the notice this evening."),
...
_add(
    ...
    ask=("이 문장으로 바꿀까요?", "Soll ich auf diesen Satz wechseln?", "Shall I change it to this sentence?"),
    wait=("문항은 내일 아침에 다시 돌리겠습니다.", "Die Frage schicke ich morgen früh neu herum.", "I will circulate the item again tomorrow morning."),
...
_add(
    ...
    ask=("이 두 숫자를 같은 줄에 둘까요?", "Soll ich diese zwei Zahlen in dieselbe Zeile?", "Shall I put these two numbers on the same line?"),
    wait=("표는 오전에 고치겠습니다.", "Die Tabelle ändere ich vormittags.", "I will fix the table in the morning."),
...
_add(
    ...
    ask=("이 지연을 일정에 넣을까요?", "Soll ich diese Verzögerung in den Plan?", "Shall I put this delay on the schedule?"),
    wait=("권한은 내일 오전에 요청하겠습니다.", "Die Freigabe beantrage ich morgen Vormittag.", "I will request access tomorrow morning."),
...
_add(
    ...
    ask=("이 순서를 칠판에 적을까요?", "Soll ich diese Reihenfolge an die Tafel?", "Shall I write this order on the board?"),
    wait=("순서는 시작 전에 바로 붙이겠습니다.", "Die Reihenfolge hänge ich gleich vor Beginn an.", "I will put the order up right before we start."),
...
_add(
    ...
    wait=("문장은 시작 전에 올려 두겠습니다.", "Den Satz stelle ich vor Beginn ein.", "I will post the sentence before we start."),
...
_add(
    ...
    ask=("이 능동 문장으로 바꿀까요?", "Soll ich auf diesen Aktivsatz wechseln?", "Shall I change it to this active sentence?"),
    wait=("기록은 오늘 저녁에 고치겠습니다.", "Den Eintrag ändere ich heute Abend.", "I will fix the record this evening."),
...
_add(
    ...
    frame="coworker",
    rel="coworker",
    sit=("요청이 위임 밖인지 경계를 확인합니다.", "Man prüft, ob die Bitte außerhalb des Mandats liegt.", "You check whether the request sits outside the mandate."),
    need=("가격을 정하는 일은 제 위임 밖이에요. 위로 가야 합니다.", "Den Preis festzulegen liegt außerhalb meines Mandats. Es muss nach oben.", "Setting the price is outside my mandate. It has to go up."),
    ...
    wait=("회신은 오후에 보내겠습니다.", "Die Antwort sende ich nachmittags.", "I will send the reply in the afternoon."),
...
_add(
    ...
    ask=("이 칸을 비움으로 표시할까요?", "Soll ich dieses Feld als leer markieren?", "Shall I mark this box as empty?"),
    wait=("표시는 오늘 안에 넣겠습니다.", "Die Markierung setze ich heute noch.", "I will put the mark in today."),
...
_add(
    ...
    ask=("이 접수 번호를 넘길까요?", "Soll ich diese Annahmenummer weitergeben?", "Shall I pass this filing number?"),
...
_add(
    ...
    ask=("이 시간대만 먼저 열까요?", "Soll ich zuerst nur dieses Zeitfenster öffnen?", "Shall I open only this time window first?"),
    wait=("로그는 한 시간 안에 받겠습니다.", "Das Protokoll habe ich in einer Stunde.", "I will have the log in an hour."),
...
_add(
    ...
    ask=("이 자리를 첫 줄로 옮길까요?", "Soll ich diesen Platz in die erste Zeile legen?", "Shall I move this spot to the first line?"),
...
_add(
    ...
    ask=("이 세 집단을 표에 넣을까요?", "Soll ich diese drei Gruppen in die Tabelle?", "Shall I put these three groups in the table?"),
    wait=("표는 내일 아침에 올리겠습니다.", "Die Tabelle stelle ich morgen früh ein.", "I will post the table tomorrow morning."),
