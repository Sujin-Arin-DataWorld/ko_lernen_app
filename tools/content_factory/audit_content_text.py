...
SURFACES: tuple[ContentSurface, ...] = (
    ...
    ContentSurface(
        ...
        ("stages",),
        "KO/DE/EN construction terms, questions, captions and explanations",
    ),
    ContentSurface(
        "learning_phases.json",
        "learning phase catalog",
        "LearningPhaseCatalog",
        ("phases",),
        "published learning phase titles and objective labels",
    ),
    ContentSurface(
        "phase_tasks.json",
        "phase task catalog",
        "PhaseTaskCatalog",
        ("tasks", "objectives"),
        "published task prompts and learning objective descriptions",
    ),
    ContentSurface(
        "culture_notes.json",
        "culture notes",
