...
void main() {
  test('store listings state the verified current content inventory', () {
    ...
    expect(englishListing, isNot(contains('558 vocabulary entries')));
    expect(englishListing, isNot(contains('64 themed packs')));
    ...
    expect(germanListing, isNot(contains('558 Vokabeleinträge')));
    expect(germanListing, isNot(contains('64 Themenpacks')));
