...
void main() {
  ...
  test('sync fixture satisfies the current course graph contract', () {
  ...
  test('serialized apply rejects a stale canonical generation', () async {
    ...
    final laterWrite = progress.recordContentAttempt(
      ...
      'grammar_greeting',
      true,
      courseContext: _assessContext(catalog, 'grammar_greeting'),
      conceptId: 'concept_greeting',
      occurredAt: _time(10),
    );
...
CoursePracticeContext _assessContext(
  ...
  String contentId,
) => CoursePracticeContext.fromLink(
  catalog
      .linksForContent(CurriculumContentKind.grammar, contentId)
...
CurriculumCatalog _catalog() {
  const units = <Map<String, dynamic>>[
    ...
    },
    {
      ...
      'requiredConceptIds': ['concept_correction'],
    },
    {
      'id': 'unit_beta',
      'level': 'a1',
