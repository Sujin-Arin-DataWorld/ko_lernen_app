...
class PhaseContentContractTest(unittest.TestCase):
    ...
    def test_a1_critical_time_quantity_and_polarity_criteria_are_required(self):
        ...
        expected = {
            'KP30:listening:01': {'relationship', 'acts', 'proposition', 'honorific', 'modern', 'condition', 'unknown'},
            'KP30:listening:02': {'structure', 'attention', 'genre', 'agreement'},
            'KP30:reading:01': {'distance', 'acts', 'written', 'limit'},
            'KP30:reading:02': {'scope', 'exception', 'current', 'responsibility', 'hearsay', 'genre'},
            'KP29:listening:01': {'self', 'rhetoric', 'quotation', 'forecast', 'declarative', 'reproach'},
            'KP29:listening:02': {'response', 'method', 'withholding', 'structure'},
            'KP29:reading:01': {'dictionary', 'function', 'modern', 'position', 'distribution'},
            'KP29:reading:02': {'criteria', 'counter', 'source', 'audience', 'limits'},
            'KP28:listening:01': {'command', 'source', 'conditional', 'question', 'challenge', 'irony', 'scope'},
            'KP28:reading:01': {'naming', 'evaluation', 'chain', 'witness', 'correction'},
            'KP28:reading:02': {'open', 'memory', 'minimal', 'topic', 'portrait'},
            'KP27:listening:01': {'resolve', 'acceptance', 'reasons', 'intention', 'obstacle', 'decision'},
            'KP27:listening:02': {'sequence', 'force', 'repair', 'limit'},
            'KP27:reading:01': {'shared', 'counter', 'strength', 'authority', 'condition', 'sense'},
            'KP26:listening:01': {'chronology', 'unknown', 'evaluation', 'habit', 'regret', 'voice'},
            'KP26:reading:01': {'order', 'completion', 'counterreading', 'neutral', 'symbol'},
            'KP26:reading:02': {'witness', 'quote', 'reporter', 'headline'},
            ...
            'KP19:listening:01': {'claim', 'before', 'simultaneous', 'additional', 'state', 'transition', 'actor'},
            'KP19:reading:02': {'count', 'agency', 'nominal', 'unsupported', 'proposal'},
            'KP24:listening:01': {'support', 'sarcasm', 'suspicion', 'agreement', 'surface', 'register'},
            'KP24:listening:02': {'structure', 'narrator', 'repair'},
            'KP24:reading:01': {'ambiguity', 'pretence', 'perspective', 'alternative', 'translation', 'honorific', 'ending'},
            'KP23:listening:01': {'chain', 'act', 'independent', 'unknown', 'definition', 'clarify'},
            'KP23:listening:02': {'structure', 'reaction', 'correction'},
            'KP23:reading:01': {'headline', 'witness', 'source', 'reaction', 'recollection', 'intention', 'unknown'},
            'KP22:listening:01': {'resolve', 'date', 'forecast', 'warning', 'exception', 'boundary'},
            'KP22:reading:01': {'deleted', 'period', 'indicators', 'premise', 'exception', 'uncertainty', 'limit'},
            'KP21:listening:01': {'premise', 'revision', 'concession', 'scope', 'authority', 'boundary'},
            'KP21:listening:02': {'turn', 'addition', 'conclusion'},
            'KP21:reading:01': {'exception', 'right', 'scope', 'scale', 'essays', 'concession', 'authority'},
            'KP20:listening:01': {'observation', 'certainty', 'remainder', 'value', 'tendency', 'intent', 'counterevidence'},
            'KP20:reading:01': {'sample', 'cause', 'measure', 'frequency', 'axes', 'preserve', 'source'},
